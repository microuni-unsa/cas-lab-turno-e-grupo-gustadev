...
if (isys_component_session::instance()->is_logged_in()) {
    /**
...
$l_attachCSS = isys_component_signalcollection::get_instance()->emit('mod.css.attachStylesheet');
...
if (is_dir($l_path) && isys_settings::get('css.caching.cache-to-temp', true)) {
    isys_file_put_contents($l_path . 'mod-style.css', $l_out);
}
