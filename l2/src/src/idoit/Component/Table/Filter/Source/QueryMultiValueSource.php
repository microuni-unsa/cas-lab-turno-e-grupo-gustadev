...
class QueryMultiValueSource implements SourceInterface
{
     ...
     */
    public function setParameterNames($parameterNames): QueryMultiValueSource
    {
     ...
     * @return QueryMultiValueSource
     */
    public function setSource($source): QueryMultiValueSource
    {
        $this->source = $source;
     ...
     * @return callable
     */
    public function getValidatorCallable(): callable
    {
     ...
     * @return QueryMultiValueSource
     */
    public function setValidatorCallable(callable $validatorCallable): QueryMultiValueSource
    {
     ...
     * @return bool
     */
    private function validateParameter($parameterName, $parameterValue): bool
    {
