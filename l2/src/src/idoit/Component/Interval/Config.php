...
class Config
{
    ...
    private string $endAfter = self::END_AFTER_NEVER;

    private int|string|DateTime|null $endDetails;

    private bool $expireIfCheckDateIsBeforeInitialDate = true;

    private DateTime $initialDate;

    private isys_component_template_language_manager $lang;

    private string|array|null $repeatDetails = null;

    private int $repeatEvery = 1;

    private string $repeatEveryUnit = self::REPEAT_UNIT_DAY;
     ...
     * @throws Exception
     */
    public static function byJSON(string $configJson): static
    {
     ...
     * @throws Exception
     */
    public static function byArray(array $config): static
    {
        ...
        return (new self($initialDate))->setRepeatEvery($config['repeatEvery'] ?: 1)
            ...
            ->setRepeatDetails((is_array($config['repeatDetails']) || is_string($config['repeatDetails'])) ? $config['repeatDetails'] : null)
     ...
     * @param string|array|null        $repeatDetails
     * @param string                   $endAfter
     * @param int|string|DateTime|null $endDetails
     *
     * @return $this
     * @throws Exception
     */
    public static function byParameters(
        ...
        int $repeatEvery = 1,
        string $repeatEveryUnit = self::REPEAT_UNIT_DAY,
        string|array|null $repeatDetails = null,
        string $endAfter = self::END_AFTER_NEVER,
        int|string|DateTime|null $endDetails = null
    ) {
     ...
     * @return $this
     */
    public function setRepeatEvery(int $repeatEvery): static
    {
     ...
     * @return string
     */
    public function getRepeatEveryUnit(): string
    {
     ...
     * @return $this
     */
    public function setRepeatEveryUnit(string $repeatEveryUnit): static
    {
     ...
     */
    public function getRepeatDetails(): string|array|null
    {
     ...
     * @return $this
     */
    public function setRepeatDetails(string|array|null $repeatDetails = null): static
    {
     ...
     * @return $this
     */
    public function setEndAfter(string $endAfter): static
    {
     ...
     */
    public function getEndDetails(): int|DateTime|null
    {
     ...
     * @return $this
     */
    public function setEndDetails(int|string|DateTime|null $endDetails = null): static
    {
     ...
     * @return bool
     */
    public function getExpireIfCheckDateIsBeforeInitialDate(): bool
    {
     ...
     * @return $this
     */
    public function setExpireIfCheckDateIsBeforeInitialDate(bool $expire = true): static
    {
     ...
     * @throws GeneralException
     */
    public function getHumanReadable(bool $includingEnd = false): string
    {
        $intervalEnd = '';
            ...
            switch ($this->endAfter) {
                ...
                case self::END_AFTER_EVENTS:
                    $intervalEnd .= strtolower($this->lang->get('LC__INTERVAL__ENDS_AFTER')) . ' ' . $this->endDetails . ' ' .
                        $this->lang->get(($this->endDetails == 1) ? 'LC__INTERVAL__ENDS_AFTER_DATE' : 'LC__INTERVAL__ENDS_AFTER_DATES');
                    break;
        ...
        switch ($this->getRepeatEveryUnit()) {
            ...
            case self::REPEAT_UNIT_WEEK:
                ...
                return ($this->repeatEvery === 1 ?
                        ...
                        $this->lang->get_in_text('LC__UNIVERSAL__EVERY_INTVERAL ' . $this->repeatEvery . ' LC__UNIVERSAL__WEEKS')) .
                        (is_array($weekDays) ? ' ' . \isys_helper_textformat::this_this_and_that($weekDays) : '') . $intervalEnd;
            ...
            case self::REPEAT_UNIT_MONTH:
                ...
                return ($this->repeatEvery === 1 ?
                        $this->lang->get_in_text('LC__UNIVERSAL__EVERY_M LC__UNIVERSAL__MONTH') :
