    ...
    public function &handle_module_request(isys_module_request $p_modreq)
    {
        ...
        $rules = [
            'object_action' => [
                ...
                'p_bInfoIconSpacer' => 0,
                'p_arData'          => [
                    1 => strtolower($this->language->get('LC__CMDB__RECORD_STATUS__DELETED')),
                    2 => strtolower($this->language->get('LC__CMDB__RECORD_STATUS__ARCHIVED'))
                ]
            ]
        ];
        ...
        $this->template
            ...
            ->smarty_tom_add_rules('tom.popup.objectpurge', $rules)
