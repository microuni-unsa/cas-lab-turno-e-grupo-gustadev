...
class isys_ajax_handler_rack extends isys_ajax_handler
{
    ...
    public function init()
    {
        ...
        switch ($_GET['func']) {
            case 'assign_object_to_rack':
                $this->assign_object_to_rack($_POST['rack_obj_id'], $_POST['obj_id'], $_POST['option'], $_POST['insertion'], $_POST['pos'], $_POST['chassisSlot']);
                break;
    ...
    protected function assign_object_to_rack($p_rack_object_id, $p_object_id, $p_option, $p_insertion, $p_position, $p_chassis_slot = 0)
    {
        ...
        try {
            ...
            $response['data'] = array_values($this->get_assigned_objects($p_rack_object_id));
        } catch (Throwable $e) {
    ...
    public function get_segments($p_rack_obj_id, $p_option, $p_insertion, $p_position)
    {
        try {
            ...
            return [
                ...
                'data'    => [
                    'slots'         => $l_return,
                    'rackQuickInfo' => (new isys_ajax_handler_quick_info)->get_quick_info(
                        $p_rack_obj_id,
                        $l_dao->get_obj_name_by_id_as_string($p_rack_obj_id),
                        C__LINK__OBJECT
                    )
                ],
                'message' => ''
    ...
    protected function create_segment_from_template($p_rack_object_id, $p_template_object_id, $p_option = null, $p_insertion = null, $p_position = null)
    {
        try {
            ...
            $l_object = $l_dao->insert_new_obj(
                $l_template['isys_obj_type__id'],
                null,
                $l_segment_object_name,
                null,
                ...
                null,
                null,
                $l_template['isys_catg_global_category__id'],
                $l_template['isys_purpose__id'],
                defined_or_default('C__CMDB_STATUS__IN_OPERATION'),
                $l_template['isys_obj__description']
            );
    ...
    protected function detach_segment($p_rack_object_id, $p_segmentation_object_id)
    {
        ...
        try {
            while ($l_assigned_objects_row = $l_assigned_objects_result->get_row()) {
                ...
                $l_location_dao->save(
                    $l_assigned_objects_row['isys_catg_location_list__id'],
                    $l_assigned_objects_row['isys_obj__id'],
                    $p_rack_object_id,
                    $p_segmentation_object_id,
                    null,
                    null,
                    null,
                    $l_assigned_objects_row['isys_catg_location_list__description'],
                    null,
            ...
            $l_segmentation_location_row = $l_location_dao->get_data(null, $p_segmentation_object_id)
                ->get_row();
            $l_location_dao->save(
                $l_segmentation_location_row['isys_catg_location_list__id'],
                $l_segmentation_location_row['isys_obj__id'],
                $p_rack_object_id,
                $p_rack_object_id,
                null,
                null,
                null,
                $l_segmentation_location_row['isys_catg_location_list__description'],
                null,
    ...
    protected function save_object_ru($p_obj_id, $p_height)
    {
        ...
        try {
            ...
            if (empty($l_row)) {
                ...
                $l_result = $l_dao->set_rack_hu((int)$p_obj_id, (int)$p_height);
            }
