        ...
        switch ($_GET["method"]) {
            ...
            case "physical-logical-location":
                if ($searchString) {
                    ...
                    $l_browser->set_format_exclude_self(false)->set_format_as_text(true);
            ...
            case "location":
                if ($searchString) {
                    // @see ID-9615 Use proper 'LocationPath' component to create a proper result for this context.
                    $l_return = isys_application::instance()->container->get('idoit.cmdb.locationpath')->getLocationPathForSuggestion($searchString);
                }
                break;
