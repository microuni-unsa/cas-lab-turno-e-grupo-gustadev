...
class isys_smarty_plugin_f_textarea extends isys_smarty_plugin_f implements isys_smarty_plugin
{
    ...
    /**
     * isys_smarty_plugin_f_wysiwyg constructor.
     * @throws Exception
     */
    public function __construct()
    {
        $this->htmlPurifier = isys_application::instance()->container->get('htmlpurifier');
    }
    ...
    public function navigation_view(isys_component_template $p_tplclass, $p_params = null)
    {
        ...
        // @see  ID-8221 The HTML purifier strips too much, so we introduce a more simple approach.
        if (isset($p_params['keepHtml']) && $p_params['keepHtml']) {
        ...
        $l_content_textarea = $this->getInfoIcon($p_params) . "<span>" . nl2br(trim($p_params["p_strValue"])) . "</span>";
