...
class isys_module_request
{
     ...
     */
    public static function build($p_menutree, $p_template, &$p_get, &$p_post, $p_objNavbar, $p_db, $p_modman, &$files = [])
    {
        if (!self::$m_instance) {
            self::$m_instance = new isys_module_request($p_menutree, $p_template, $p_get, $p_post, $p_objNavbar, $p_db, $p_modman, $files);
        }
     ...
     * @deprecated Better use container
     */
     ...
     * @param isys_module_manager            $p_modman
     */
    private function __construct($p_menutree, $p_template, &$p_get, &$p_post, $p_objNavbar, $p_db, $p_modman, &$files = [])
    {
        $p_get = $p_get;
        $p_post = $p_post;
