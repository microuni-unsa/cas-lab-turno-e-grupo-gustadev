...
<div id="monitoring_config">
    <h3 class="p5 pt10 pb10 bg-neutral-200 border-bottom">[{isys type="lang" ident="LC__MONITORING__EXPORT__CONFIGURATION_EDIT"}]</h3>
    ...
    <table class="contentTable">
        ...
        <tr>
            ...
            <td class="value">
                ...
                <br class="cb" />
                <span class="ml20 text-neutral-400">* [{isys type="lang" ident="LC__MONITORING__MONITORING_ADDRESS_INFO"}]</span>
            </td>
        </tr>
    </table>

    <h3 class="p5 pt10 pb10 bg-neutral-200 border-top border-bottom">[{isys type="lang" ident="LC__MONITORING__EXPORT__CONFIGURATION_OPTIONS"}]</h3>
