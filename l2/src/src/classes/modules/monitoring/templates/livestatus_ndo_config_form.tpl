...
<table class="contentTable">
    ...
    <tr class="livestatus tcp">
        <td class="key">[{isys type="f_label" ident="LC__MONITORING__USE_SSL" name="C__MONITORING__CONFIG__USE_SSL"}]</td>
        <td class="value">[{isys type="f_dialog" name="C__MONITORING__CONFIG__USE_SSL" p_bDbFieldNN=true}]</td>
    </tr>
    <tr class="ndo">
