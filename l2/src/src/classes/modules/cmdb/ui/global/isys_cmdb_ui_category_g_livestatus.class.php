...
class isys_cmdb_ui_category_g_livestatus extends isys_cmdb_ui_category_global
{
    ...
    public function process(isys_cmdb_dao_category $p_cat)
    {
        ...
        $livestatusRow = isys_cmdb_dao_category_g_monitoring::instance($this->m_database_component)
        ...
        $this->deactivate_commentary()
            ...
            ->assign('active', (bool)$livestatusRow['isys_catg_monitoring_list__active'])
            ->assign('livestatus_host', (int)$livestatusRow['isys_catg_monitoring_list__isys_monitoring_hosts__id'])
