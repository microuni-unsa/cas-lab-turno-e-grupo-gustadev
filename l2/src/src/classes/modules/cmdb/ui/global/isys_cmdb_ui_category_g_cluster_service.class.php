...
class isys_cmdb_ui_category_g_cluster_service extends isys_cmdb_ui_category_global
{
    ...
    public function process(isys_cmdb_dao_category $p_cat)
    {
        ...
        isys_application::instance()->template->assign(
            ...
            "?" . http_build_query($_GET, '', "&") . "&ajax=1&call=category&cluster_options=1" . $l_editMode . "&" . C__CMDB__GET__CATLEVEL . "=" . $l_id
        )
            ->assign("cluster_service_obj_id", $l_catdata["isys_connection__isys_obj__id"]);

        $l_rules["C__CMDB__CATG__CLUSTER_SERVICE__APPLICATION"]["p_strSelectedID"] = $l_catdata["isys_connection__isys_obj__id"];
