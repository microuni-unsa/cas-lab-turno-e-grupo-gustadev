...
class isys_cmdb_ui_category_g_identifier extends isys_cmdb_ui_category_global
{
    ...
    public function process(isys_cmdb_dao_category $p_cat)
    {
        ...
        if ($l_rules['C__CMDB__CATG__IDENTIFIER__LAST_EDITED']['p_strValue'] === C__FALLBACK_EMPTY_DATETIME
            || $l_rules['C__CMDB__CATG__IDENTIFIER__LAST_EDITED']['p_strValue'] === C__FALLBACK_EMPTY_DATETIME_TZ) {
            /**
