...
class isys_cmdb_ui_category_g_connector extends isys_cmdb_ui_category_global
{
    ...
    public function process(isys_cmdb_dao_category $p_cat)
    {
        ...
        $l_rules['C__CATG__CONNECTOR__CONNECTION_TYPE']['p_bInfoIconSpacer'] = 0;
        ...
        if ($l_new) {
            ...
            if (!isset($l_rules['C__CATG__CONNECTOR__SUFFIX_SCHEMA']['p_strSelectedID'])) {
                $l_rules['C__CATG__CONNECTOR__SUFFIX_SCHEMA']['p_strSelectedID']= 0;
            };
        }
        ...
        if ($l_catdata['isys_catg_connector_list__assigned_category'] === 'C__CATG__UNIVERSAL_INTERFACE') {
            ...
            $this->get_template_component()
                ->assign('connection_type', $language->get($l_ui_row['isys_ui_plugtype__title']));
        }
    ...
    public function process_list(
        ...
        if (isys_application::isPro() && class_exists('isys_popup_connection')) {
            ...
            isys_component_template_navbar::getInstance()
                ->append_button('LC__CABLE_CONNECTION__POPUP_CONNECTION', 'ConnectionPopup', [
                    ...
                    'icon'          => 'axialis/hardware-network/power-plug.svg',
                    'icon_inactive' => 'axialis/hardware-network/power-plug.svg',
                    'js_onclick'    => $l_js_onclick,
                ]);
        }

        $sortDirection = isys_glob_get_param("dir");
        ...
        $this->deactivate_commentary()
            ...
            ->assign('list_dao', $l_dao_list)
            ->assign('sortField', isys_glob_get_param("sort"))
            ->assign('sortDirection', $sortDirection)
