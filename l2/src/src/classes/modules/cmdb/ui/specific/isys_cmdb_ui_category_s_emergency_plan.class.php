...
class isys_cmdb_ui_category_s_emergency_plan extends isys_cmdb_ui_category_specific
{
    ...
    public function process(isys_cmdb_dao_category $p_cat)
    {
        ...
        // @see ID-8119 has to be set explicit because the subcategory has a different category id
        $l_rules['C__CMDB__CAT__COMMENTARY_' . C__CMDB__CATEGORY__TYPE_SPECIFIC . $p_cat->get_category_id()]['p_strValue'] =
            $l_catdata['isys_cats_emergency_plan_list__description'];
