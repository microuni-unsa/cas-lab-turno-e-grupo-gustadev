...
class isys_cmdb_ui_category_s_person_assigned_groups extends isys_cmdb_ui_category_specific
{
    ...
    public function process_list(
        ...
        isys_component_template_navbar::getInstance()
            ...
            ->set_title(isys_application::instance()->container->get('language')->get('LC__UNIVERSAL__OBJECT_ADD_REMOVE'), C__NAVBAR_BUTTON__NEW)
            ->set_tooltip(isys_application::instance()->container->get('language')->get('LC__UNIVERSAL__OBJECT_ADD_REMOVE_DESCRIPTION'), C__NAVBAR_BUTTON__NEW)
        ...
        $this->list_view(
            ...
            $_GET[C__CMDB__GET__OBJECT],
            isys_cmdb_dao_list_cats_person_assigned_groups::build($p_cat->get_database_component(), $p_cat),
            null,
            null,
            null,
            false
