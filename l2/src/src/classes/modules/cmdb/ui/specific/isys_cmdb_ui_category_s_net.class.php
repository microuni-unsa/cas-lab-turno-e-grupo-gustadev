...
class isys_cmdb_ui_category_s_net extends isys_cmdb_ui_category_specific
{
    ...
    public function process(isys_cmdb_dao_category $p_cat)
    {
        ...
        if (empty($l_catdata['isys_cats_net_list__address'])) {
            $l_rules['C__CATS__NET__TYPE']['p_bDisabled'] = false;
        }
        ...
        if ($l_catdata['isys_cats_net_list__isys_net_type__id'] == defined_or_default('C__CATS_NET_TYPE__IPV4')) {
            ...
            // @see ID-12157 Fill both fields with from / to values.
            $l_rules['C__CATS__NET__ADDRESS_RANGE_FROM']['p_strValue'] = $l_rules['C__CATS__NET__ADDRESS_RANGE_FROM_V4']['p_strValue'];
            $l_rules['C__CATS__NET__ADDRESS_RANGE_TO']['p_strValue'] = $l_rules['C__CATS__NET__ADDRESS_RANGE_TO_V4']['p_strValue'];
        }
