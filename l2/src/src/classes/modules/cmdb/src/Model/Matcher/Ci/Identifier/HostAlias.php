 ...
 */
class HostAlias extends AbstractIdentifier
{
    /**
     ...
     * @var string
     */
    protected $title = 'Host Alias';

    /**
     * @inherit
     * @var int
     */
    protected static $bit = 524288;
    ...
    public function __construct()
    {
        ...
        $this->dataSqlSelect = "SELECT CONCAT_WS('.', isys_hostaddress_pairs__hostname, isys_hostaddress_pairs__domain) AS '" . self::KEY . "'
            FROM isys_catg_ip_list
