...
abstract class isys_cmdb_view
{
     ...
     * @param  array $l_gets
     */
    abstract public function get_mandatory_parameters(&$l_gets);
     ...
     * @param  array $l_gets
     */
    abstract public function get_optional_parameters(&$l_gets);
    ...
    public function __construct(isys_module_request $p_modreq)
    {
        ...
        $this->m_dao_cmdb = $cmdbDao;
        $this->m_action_proc = new isys_cmdb_action_processor($cmdbDao);
