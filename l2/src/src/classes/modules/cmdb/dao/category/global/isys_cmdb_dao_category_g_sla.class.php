...
class isys_cmdb_dao_category_g_sla extends isys_cmdb_dao_category_global
{
    ...
    public static function calculate_time_to_seconds($p_time)
    {
        ...
        if (preg_match('~([01]?[0-9]|2[0-3]):?([0-5]?[0-9])?~', $p_time)) {
            [$l_hour, $l_minute] = explode(':', $p_time);
    ...
    {
        return parent::create_data($this->prepare_data($p_data));
    }
    ...
    {
        return parent::save_data($p_category_data_id, $this->prepare_data($p_data));
    }
    ...
    public function getSlaTimes($row)
    {
        ...
        $data = $this->get_data($row['isys_catg_sla_list__id'])->get_row();
        ...
        foreach (array_keys($data) as $key) {
            if (array_key_exists($key, $daysMapping)) {
                if ($data[$key] != null) {
                    ...
                    $slaTimes[$language->get($daysMapping[$key])] = $language->get($daysMapping[$key]) . ': ' . $fromAndTo['from'] . ' => ' . $fromAndTo['to'];
                }
            }
        }
    ...
    {
        return [
            '_sla_times' => new DynamicProperty(
                'LC__CMDB__CATG__SLA_TIMES',
    ...
    {
        return [
            'service_id'           => new TextProperty(
                'C__CATG__SLA__SERVICE_ID',
                'LC__CMDB__CATG__SLA_SERVICE_ID',
                'isys_catg_sla_list__service_id',
                'isys_catg_sla_list',
            ),
            'service_level'        => array_replace_recursive(isys_cmdb_dao_category_pattern::dialog(), [
                ...
                C__PROPERTY__DATA   => [
                    ...
                    C__PROPERTY__DATA__SORT => 'SELECT isys_catg_sla_list__service_level FROM isys_catg_sla_list
                                WHERE isys_catg_sla_list__isys_obj__id = obj_main.isys_obj__id LIMIT 1'
                ],
                C__PROPERTY__UI     => [
            ...
            'monday_time'          => new TimeperiodProperty(
                'C__CATG__SLA__WEEK_DAY__MONDAY_TIME',
                'LC__UNIVERSAL__CALENDAR__DAYS_MONDAY',
                'isys_catg_sla_list__monday_time',
                'isys_catg_sla_list',
                ['isys_export_helper', 'sla_property_servicetimes']
            ),
            'tuesday_time'         => new TimeperiodProperty(
                'C__CATG__SLA__WEEK_DAY__TUESDAY_TIME',
                'LC__UNIVERSAL__CALENDAR__DAYS_TUESDAY',
                'isys_catg_sla_list__tuesday_time',
                'isys_catg_sla_list',
                ['isys_export_helper', 'sla_property_servicetimes']
            ),
            'wednesday_time'       => new TimeperiodProperty(
                'C__CATG__SLA__WEEK_DAY__WEDNESDAY_TIME',
                'LC__UNIVERSAL__CALENDAR__DAYS_WEDNESDAY',
                'isys_catg_sla_list__wednesday_time',
                'isys_catg_sla_list',
                ['isys_export_helper', 'sla_property_servicetimes']
            ),
            'thursday_time'       => new TimeperiodProperty(
                'C__CATG__SLA__WEEK_DAY__THURSDAY_TIME',
                'LC__UNIVERSAL__CALENDAR__DAYS_THURSDAY',
                'isys_catg_sla_list__thursday_time',
                'isys_catg_sla_list',
                ['isys_export_helper', 'sla_property_servicetimes']
            ),
            'friday_time'       => new TimeperiodProperty(
                'C__CATG__SLA__WEEK_DAY__FRIDAY_TIME',
                'LC__UNIVERSAL__CALENDAR__DAYS_FRIDAY',
                'isys_catg_sla_list__friday_time',
                'isys_catg_sla_list',
                ['isys_export_helper', 'sla_property_servicetimes']
            ),
            'saturday_time'       => new TimeperiodProperty(
                'C__CATG__SLA__WEEK_DAY__SATURDAY_TIME',
                'LC__UNIVERSAL__CALENDAR__DAYS_SATURDAY',
                'isys_catg_sla_list__saturday_time',
                'isys_catg_sla_list',
                ['isys_export_helper', 'sla_property_servicetimes']
            ),
            'sunday_time'       => new TimeperiodProperty(
                'C__CATG__SLA__WEEK_DAY__SUNDAY_TIME',
                'LC__UNIVERSAL__CALENDAR__DAYS_SUNDAY',
                'isys_catg_sla_list__sunday_time',
                'isys_catg_sla_list',
                ['isys_export_helper', 'sla_property_servicetimes']
            ),
            'reaction_time'        => (new FloatProperty(
                'C__CATG__SLA__REACTION_INTERVAL',
                'LC__CMDB__CATS__SLA_REACTIONTIME',
                'isys_catg_sla_list__reaction_time',
                'isys_catg_sla_list'
            ))->mergePropertyUiParams([
                'p_strClass' => 'input-mini'
            ]),
            'reaction_time_unit'   => (new DialogProperty(
                'C__CATG__SLA__REACTION_INTERVAL_UNIT',
                'LC__CMDB__CATS__SLA_REACTIONTIME_UNIT',
            ...
            'recovery_time'        => (new FloatProperty(
                'C__CATG__SLA__RECOVERY_INTERVAL',
                'LC__CMDB__CATS__SLA_RECOVERYTIME',
                'isys_catg_sla_list__recovery_time',
                'isys_catg_sla_list'
            ))->mergePropertyUiParams([
                'p_strClass' => 'input-mini'
            ]),
            'recovery_time_unit'   => (new DialogProperty(
                'C__CATG__SLA__RECOVERY_INTERVAL_UNIT',
                'LC__CMDB__CATS__SLA_RECOVERYTIME_UNIT',
            ...
            'description' => new CommentaryProperty(
                'C__CMDB__CAT__COMMENTARY_' . C__CMDB__CATEGORY__TYPE_GLOBAL . defined_or_default('C__CATG__SLA', 'C__CATG__SLA'),
