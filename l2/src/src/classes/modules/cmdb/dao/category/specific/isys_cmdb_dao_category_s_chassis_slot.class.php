        ...
        return [
            'connector_type'   => array_replace_recursive(isys_cmdb_dao_category_pattern::dialog_plus(), [
                ...
                C__PROPERTY__DATA   => [
                    ...
                    C__PROPERTY__DATA__SELECT       => idoit\Module\Report\SqlQuery\Structure\SelectSubSelect::factory(
                        'SELECT isys_chassis_connector_type__title
                            FROM isys_cats_chassis_slot_list
                        ...
                        'isys_cats_chassis_slot_list__id',
                        'isys_cats_chassis_slot_list__isys_obj__id',
                        '',
                        '',
                        null,
                    ...
                    C__PROPERTY__DATA__JOIN         => [
                        ...
                        idoit\Module\Report\SqlQuery\Structure\SelectJoin::factory(
                            'isys_chassis_connector_type',
                            'LEFT',
                            'isys_cats_chassis_slot_list__isys_chassis_connector_type__id',
                            'isys_chassis_connector_type__id'
                        )
                    ]
                ],
            ...
            'title'            => array_replace_recursive(isys_cmdb_dao_category_pattern::text(), [
                ...
                C__PROPERTY__DATA => [
                    ...
                    C__PROPERTY__DATA__SELECT => idoit\Module\Report\SqlQuery\Structure\SelectSubSelect::factory(
                        'SELECT isys_cats_chassis_slot_list__title FROM isys_cats_chassis_slot_list',
                        'isys_cats_chassis_slot_list',
                        'isys_cats_chassis_slot_list__id',
                        'isys_cats_chassis_slot_list__isys_obj__id',
                        '',
                ...
                C__PROPERTY__DATA     => [
                    ...
                    C__PROPERTY__DATA__SELECT => idoit\Module\Report\SqlQuery\Structure\SelectSubSelect::factory(
                        'SELECT
                            ...
                            LEFT JOIN isys_catg_pc_list ON isys_catg_pc_list__id = ch.isys_cats_chassis_list__isys_catg_pc_list__id',
                        'isys_cats_chassis_slot_list',
                        'main.isys_cats_chassis_slot_list__id',
                        'main.isys_cats_chassis_slot_list__isys_obj__id',
                        '',
                        '',
                        null,
            ...
            'description'      => array_replace_recursive(isys_cmdb_dao_category_pattern::commentary(), [
                ...
                C__PROPERTY__DATA => [
                    ...
                    C__PROPERTY__DATA__SELECT => idoit\Module\Report\SqlQuery\Structure\SelectSubSelect::factory(
                        'SELECT isys_cats_chassis_slot_list__description FROM isys_cats_chassis_slot_list',
                        'isys_cats_chassis_slot_list',
                        'isys_cats_chassis_slot_list__id',
                        'isys_cats_chassis_slot_list__isys_obj__id',
                        '',
