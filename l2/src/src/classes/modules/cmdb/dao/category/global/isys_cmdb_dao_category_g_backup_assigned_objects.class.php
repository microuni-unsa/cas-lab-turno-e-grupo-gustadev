...
class isys_cmdb_dao_category_g_backup_assigned_objects extends isys_cmdb_dao_category_global
{
    ...
    public function properties()
    {
        ...
        $l_properties['title'][C__PROPERTY__DATA][C__PROPERTY__DATA__SELECT] = idoit\Module\Report\SqlQuery\Structure\SelectSubSelect::factory(
            'SELECT isys_catg_backup_list__title FROM isys_catg_backup_list
                INNER JOIN isys_connection ON isys_connection__id = isys_catg_backup_list__isys_connection__id',
            'isys_connection',
            'isys_connection__id',
        ...
        $l_properties['path_to_save'][C__PROPERTY__DATA][C__PROPERTY__DATA__SELECT] = idoit\Module\Report\SqlQuery\Structure\SelectSubSelect::factory(
            'SELECT isys_catg_backup_list__path_to_save FROM isys_catg_backup_list
                INNER JOIN isys_connection ON isys_connection__id = isys_catg_backup_list__isys_connection__id',
            'isys_connection',
            'isys_connection__id',
            'isys_connection__isys_obj__id'
        ...
        $l_properties['backup'][C__PROPERTY__DATA][C__PROPERTY__DATA__SELECT] = idoit\Module\Report\SqlQuery\Structure\SelectSubSelect::factory(
        ...
        // Do not 'unset' property data, this might lead to errors when using Property classes.
        $l_properties['backup'][C__PROPERTY__DATA][C__PROPERTY__DATA__REFERENCES] = null;
