        ...
        return [
            'type'          => array_replace_recursive(isys_cmdb_dao_category_pattern::text(), [
                ...
                C__PROPERTY__DATA => [
                    ...
                    C__PROPERTY__DATA__SELECT => idoit\Module\Report\SqlQuery\Structure\SelectSubSelect::factory(
                        'SELECT isys_cats_database_gateway_list__type FROM isys_cats_database_gateway_list',
                        'isys_cats_database_gateway_list',
                        'isys_cats_database_gateway_list__id',
                        'isys_cats_database_gateway_list__isys_obj__id',
                        '',
                        '',
                        null,
            ...
            'host'          => array_replace_recursive(isys_cmdb_dao_category_pattern::text(), [
                ...
                C__PROPERTY__DATA => [
                    ...
                    C__PROPERTY__DATA__SELECT => idoit\Module\Report\SqlQuery\Structure\SelectSubSelect::factory(
                        'SELECT isys_cats_database_gateway_list__host FROM isys_cats_database_gateway_list',
                        'isys_cats_database_gateway_list',
                        'isys_cats_database_gateway_list__id',
                        'isys_cats_database_gateway_list__isys_obj__id',
                        '',
            ...
            'port'          => array_replace_recursive(isys_cmdb_dao_category_pattern::text(), [
                ...
                C__PROPERTY__DATA => [
                    ...
                    C__PROPERTY__DATA__SELECT => idoit\Module\Report\SqlQuery\Structure\SelectSubSelect::factory(
                        'SELECT isys_cats_database_gateway_list__port FROM isys_cats_database_gateway_list',
                        'isys_cats_database_gateway_list',
                        'isys_cats_database_gateway_list__id',
                        'isys_cats_database_gateway_list__isys_obj__id',
                        '',
            ...
            'user'          => array_replace_recursive(isys_cmdb_dao_category_pattern::text(), [
                ...
                C__PROPERTY__DATA => [
                    ...
                    C__PROPERTY__DATA__SELECT => idoit\Module\Report\SqlQuery\Structure\SelectSubSelect::factory(
                        'SELECT isys_cats_database_gateway_list__user FROM isys_cats_database_gateway_list',
                        'isys_cats_database_gateway_list',
                        'isys_cats_database_gateway_list__id',
                        'isys_cats_database_gateway_list__isys_obj__id',
                        '',
                ...
                C__PROPERTY__DATA     => [
                    ...
                    C__PROPERTY__DATA__JOIN             => [
                        ...
                        idoit\Module\Report\SqlQuery\Structure\SelectJoin::factory(
                            'isys_connection',
                            'LEFT',
                            'isys_cats_database_gateway_list__isys_connection__id',
                            'isys_connection__id'
                        ),
            ...
            'description'   => array_replace_recursive(isys_cmdb_dao_category_pattern::commentary(), [
                ...
                C__PROPERTY__DATA => [
                    ...
                    C__PROPERTY__DATA__SELECT => idoit\Module\Report\SqlQuery\Structure\SelectSubSelect::factory(
                        'SELECT isys_cats_database_gateway_list__description FROM isys_cats_database_gateway_list',
                        'isys_cats_database_gateway_list',
                        'isys_cats_database_gateway_list__id',
                        'isys_cats_database_gateway_list__isys_obj__id',
                        '',
    ...
    public function save($p_cat_level, $p_newRecStatus, $p_type, $p_host, $p_port, $p_user, $p_connectedObjID, $p_description)
    {
        ...
        if ($this->update($l_strSql) && $this->apply_update()) {
            ...
            $l_relation_dao->handle_relation(
                $p_cat_level,
                "isys_cats_database_gateway_list",
                defined_or_default('C__RELATION_TYPE__DATABASE_GATEWAY'),
