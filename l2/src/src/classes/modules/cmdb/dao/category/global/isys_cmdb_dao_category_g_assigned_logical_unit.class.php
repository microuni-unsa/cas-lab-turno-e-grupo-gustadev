 ...
 */
class isys_cmdb_dao_category_g_assigned_logical_unit extends isys_cmdb_dao_category_global implements ObjectBrowserReceiver, ObjectBrowserAssignedEntries
{
    /**
        ...
        return [
            'assigned_object' => array_replace_recursive(isys_cmdb_dao_category_pattern::object_browser(), [
                C__PROPERTY__INFO     => [
                    ...
                    C__PROPERTY__INFO__BACKWARD_PROPERTY => 'isys_cmdb_dao_category_g_assigned_workstation::parent'
                ],
                C__PROPERTY__DATA     => [
    ...
    {
        // @see ID-9190
        if (Context::instance()->getContextTechnical() === Context::CONTEXT_IMPORT_XML &&
    ...
    public function getAttachedEntries($ids, $tag = '', $asId = false): CollectionInterface
    {
        ...
        $query = 'SELECT isys_catg_logical_unit_list__id as id, isys_obj__id as objId, isys_obj__title as title, isys_obj__sysid as sysid, isys_obj_type__title as objType
            ...
            WHERE isys_catg_logical_unit_list__isys_obj__id__parent IN (' . implode(',', array_map(function ($id) {
