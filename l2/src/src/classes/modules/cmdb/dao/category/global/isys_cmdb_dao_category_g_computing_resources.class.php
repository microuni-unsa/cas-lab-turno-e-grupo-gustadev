...
class isys_cmdb_dao_category_g_computing_resources extends isys_cmdb_dao_category_global
{
    ...
    public function dynamic_property_callback_ram(array $p_row)
    {
        ...
        $l_row = $this->get_data(null, $p_row['isys_obj__id'])->get_row();

        if ($l_row) {
            $unitName = '';

            if ($l_row['isys_catg_computing_resources_list__ram__isys_memory_unit__id']) {
                $unitName = $this
                    ->get_dialog('isys_memory_unit', $l_row['isys_catg_computing_resources_list__ram__isys_memory_unit__id'])
            ...
            )) . ' ' . isys_application::instance()->container->get('language')->get($unitName);
        }
    ...
    public function dynamic_property_callback_cpu(array $p_row)
    {
        ...
        if ($l_row) {
            ...
            if ($l_row['isys_catg_computing_resources_list__cpu__isys_frequency_unit__id']) {
                $unitName = $this
                    ->get_dialog('isys_frequency_unit', $l_row['isys_catg_computing_resources_list__cpu__isys_frequency_unit__id'])
    ...
    public function dynamic_property_callback_disc_space(array $p_row)
    {
        ...
        if ($l_row) {
            ...
            if ($l_row['isys_catg_computing_resources_list__ds__isys_memory_unit__id']) {
                $unitName = $this
                    ->get_dialog('isys_memory_unit', $l_row['isys_catg_computing_resources_list__ds__isys_memory_unit__id'])
                    ->get_row_value('isys_memory_unit__title');
            }
    ...
    public function dynamic_property_callback_network_bandwidth(array $p_row)
    {
        ...
        if ($l_row) {
            ...
            if ($l_row['isys_catg_computing_resources_list__nb__isys_port_speed__id']) {
                $unitName = $this
                    ->get_dialog('isys_port_speed', $l_row['isys_catg_computing_resources_list__nb__isys_port_speed__id'])
    ...
    {
        return [
            '_ram' => new DynamicProperty(
                'LC__CMDB__CATG__COMPUTING_RESOURCES__RAM',
            ...
            '_disc_space' => new DynamicProperty(
                'LC__CMDB__CATG__COMPUTING_RESOURCES__DISC_SPACE',
                'isys_catg_computing_resources_list__isys_obj__id',
                'isys_catg_computing_resources_list',
                [
                    $this,
            ...
            '_network_bandwidth' => new DynamicProperty(
                'LC__CMDB__CATG__COMPUTING_RESOURCES__NETWORK_BANDWIDTH',
                'isys_catg_computing_resources_list__isys_obj__id',
                'isys_catg_computing_resources_list',
                [
                    $this,
    ...
    protected function properties()
    {
        return [
            ...
            'ram_unit'               => array_replace_recursive(isys_cmdb_dao_category_pattern::dialog(), [
                C__PROPERTY__INFO     => [
                    C__PROPERTY__INFO__TITLE       => 'LC__CMDB__CATG__COMPUTING_RESOURCES__RAM_UNIT',
