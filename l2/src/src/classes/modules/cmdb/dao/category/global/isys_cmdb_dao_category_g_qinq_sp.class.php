 ...
 */
class isys_cmdb_dao_category_g_qinq_sp extends isys_cmdb_dao_category_global implements ObjectBrowserAssignedEntries
{
     ...
     * @return  boolean
     */
    public function save(&$p_category_id, $p_status, $p_spvlan, $p_object_id = null, $p_relation_id = null, $p_description = null)
    {
        // Get old data
        ...
        if (isset($p_spvlan) && is_numeric($p_spvlan)) {
            ...
            } elseif ($l_old_data['isys_connection__isys_obj__id'] != $p_spvlan) {
        ...
        if ($this->update($l_sql) && $this->apply_update()) {
            ...
            $l_relation_dao->handle_relation(
                $p_category_id,
                $this->m_table,
                defined_or_default('C__RELATION_TYPE__LAYER2_TRANSPORT'),
        ...
        return [
            'spvlan'      => array_replace_recursive(isys_cmdb_dao_category_pattern::object_browser(), [
                C__PROPERTY__INFO     => [
                    ...
                    C__PROPERTY__INFO__BACKWARD_PROPERTY => 'isys_cmdb_dao_category_g_qinq_ce::spvlan'
                ],
                C__PROPERTY__DATA     => [
