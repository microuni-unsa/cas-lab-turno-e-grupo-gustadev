...
class isys_cmdb_dao_category_g_virtual_switch extends isys_cmdb_dao_category_global
{
        ...
        return [
            'title'               => array_replace_recursive(isys_cmdb_dao_category_pattern::text(), [
                ...
                C__PROPERTY__DATA     => [
                    ...
                    C__PROPERTY__DATA__SELECT => SelectSubSelect::factory(
                        'SELECT isys_catg_virtual_switch_list__title FROM isys_catg_virtual_switch_list',
                        'isys_catg_virtual_switch_list',
                        'isys_catg_virtual_switch_list__id',
                        'isys_catg_virtual_switch_list__isys_obj__id',
                        '',
                        '',
                        null,
                        SelectGroupBy::factory(['isys_catg_virtual_switch_list__isys_obj__id'])
                    )
                ],
                C__PROPERTY__UI       => [
            ...
            'ports'               => array_replace_recursive(isys_cmdb_dao_category_pattern::dialog_list(), [
                ...
                C__PROPERTY__DATA     => [
                    ...
                    C__PROPERTY__DATA__SELECT     => SelectSubSelect::factory(
                        'SELECT CONCAT(isys_catg_virtual_switch_list__title, \' > \', isys_catg_port_list__title)
                    ...
                    C__PROPERTY__DATA__JOIN       => [
                        SelectJoin::factory('isys_catg_virtual_switch_list', 'LEFT', 'isys_catg_virtual_switch_list__isys_obj__id', 'isys_obj__id'),
                        SelectJoin::factory('isys_virtual_switch_2_port', 'LEFT', 'isys_catg_virtual_switch_list__id', 'isys_virtual_switch_2_port__isys_catg_virtual_switch_list__id'),
                        SelectJoin::factory('isys_catg_port_list', 'LEFT', 'isys_virtual_switch_2_port__isys_catg_port_list__id', 'isys_catg_port_list__id')
                    ]
                ],
                C__PROPERTY__UI       => [
            ...
            'portgroup'           => array_replace_recursive(isys_cmdb_dao_category_pattern::dialog(), [
                ...
                C__PROPERTY__DATA     => [
                    ...
                    C__PROPERTY__DATA__SELECT     => SelectSubSelect::factory(
                        'SELECT CONCAT(isys_catg_virtual_switch_list__title, \' > \', isys_virtual_port_group__title, \' (VLAN ID: \', isys_virtual_port_group__vlanid, \')\')
                            FROM isys_catg_virtual_switch_list
                    ...
                    C__PROPERTY__DATA__JOIN       => [
                        SelectJoin::factory('isys_catg_virtual_switch_list', 'LEFT', 'isys_catg_virtual_switch_list__isys_obj__id', 'isys_obj__id'),
                        SelectJoin::factory('isys_virtual_port_group', 'LEFT', 'isys_catg_virtual_switch_list__id', 'isys_virtual_port_group__isys_catg_virtual_switch_list__id')
                    ]
                ],
                C__PROPERTY__UI => [
                    C__PROPERTY__UI__PARAMS => [
                        'p_strTable' => 'isys_catg_virtual_switch_list'
                    ]
                ],
                C__PROPERTY__FORMAT   => [
                    C__PROPERTY__FORMAT__CALLBACK => [
            ...
            'serviceconsoleports' => array_replace_recursive(isys_cmdb_dao_category_pattern::dialog(), [
                ...
                C__PROPERTY__DATA     => [
                    ...
                    C__PROPERTY__DATA__SELECT     => SelectSubSelect::factory(
                        'SELECT CONCAT(isys_service_console_port__title, \' (IP: \', isys_cats_net_ip_addresses_list__title, \')\')
                            FROM isys_catg_virtual_switch_list
                    ...
                    C__PROPERTY__DATA__JOIN       => [
                        SelectJoin::factory('isys_catg_virtual_switch_list', 'LEFT', 'isys_catg_virtual_switch_list__isys_obj__id', 'isys_obj__id'),
                        SelectJoin::factory('isys_service_console_port', 'LEFT', 'isys_catg_virtual_switch_list__id', 'isys_service_console_port__isys_catg_virtual_switch_list__id'),
                        SelectJoin::factory('isys_catg_ip_list', 'LEFT', 'isys_service_console_port__isys_catg_ip_list__id', 'isys_catg_ip_list__id'),
                        SelectJoin::factory('isys_cats_net_ip_addresses_list', 'LEFT', 'isys_catg_ip_list__isys_cats_net_ip_addresses_list__id', 'isys_cats_net_ip_addresses_list__id')
                    ]
                ],
                C__PROPERTY__FORMAT   => [
                    C__PROPERTY__FORMAT__CALLBACK => [
            ...
            'vmkernelports'       => array_replace_recursive(isys_cmdb_dao_category_pattern::dialog(), [
                ...
                C__PROPERTY__DATA     => [
                    ...
                    C__PROPERTY__DATA__SELECT     => SelectSubSelect::factory(
                        'SELECT CONCAT(isys_vmkernel_port__title, \' (IP: \', isys_cats_net_ip_addresses_list__title, \')\')
                            FROM isys_catg_virtual_switch_list
                    ...
                    C__PROPERTY__DATA__JOIN       => [
                        SelectJoin::factory('isys_catg_virtual_switch_list', 'LEFT', 'isys_catg_virtual_switch_list__isys_obj__id', 'isys_obj__id'),
                        SelectJoin::factory('isys_vmkernel_port', 'LEFT', 'isys_catg_virtual_switch_list__id', 'isys_vmkernel_port__isys_catg_virtual_switch_list__id'),
                        SelectJoin::factory('isys_catg_ip_list', 'LEFT', 'isys_vmkernel_port__isys_catg_ip_list__id', 'isys_catg_ip_list__id'),
                        SelectJoin::factory('isys_cats_net_ip_addresses_list', 'LEFT', 'isys_catg_ip_list__isys_cats_net_ip_addresses_list__id', 'isys_cats_net_ip_addresses_list__id')
                    ]
                ],
                C__PROPERTY__FORMAT   => [
    ...
    public function attach_port_groups($p_catlevel, $p_pgs)
    {
        ...
        return (count($p_pgs) === 1) ? $this->get_last_insert_id() : true;
    }
    ...
    /**
     * @param      $p_objID
     * @param null $portGroupId
     *
     * @return isys_component_dao_result
     * @throws isys_exception_database
     */
    public function get_connected_clients($p_objID, $portGroupId = null)
    {
        ...
        $l_query = "SELECT isys_obj__id, isys_obj__isys_obj_type__id, isys_obj__title FROM isys_virtual_device_host " .
            ...
            "WHERE isys_virtual_device_host__isys_virtual_port_group__id = " . $this->convert_sql_id($portGroupId) . " " . "AND isys_connection__isys_obj__id " .
