...
class isys_cmdb_dao_category_g_net_connector extends isys_cmdb_dao_category_global
{
     ...
     * @var string
     */
    protected $categoryTitle = 'LC__CATG__NET_CONNECTOR';
    ...
    public function callback_property_relation_handler(isys_request $p_request, $p_parameters = [])
    {
        ...
        if (($l_data_id = $p_request->get_category_data_id())) {
            $l_dao_net_con = isys_cmdb_dao_category_g_net_connector::instance(isys_application::instance()->container->get('database'));
            ...
            $l_dao_listener = isys_cmdb_dao_category_g_net_listener::instance(isys_application::instance()->container->get('database'));
    ...
    protected function properties()
    {
        return [
            ...
            'port_from'          => array_replace_recursive(isys_cmdb_dao_category_pattern::int(), [
                C__PROPERTY__INFO => [
                    C__PROPERTY__INFO__TITLE       => 'LC__CATG__NET_CONNECTIONS__PORT_RANGE_FROM',
            ...
            'port_to'            => array_replace_recursive(isys_cmdb_dao_category_pattern::int(), [
                C__PROPERTY__INFO => [
                    C__PROPERTY__INFO__TITLE       => 'LC__CATG__NET_CONNECTIONS__PORT_RANGE_TO',
