...
class isys_cmdb_dao_category_s_application extends isys_cmdb_dao_category_specific
{
    ...
    /** @var string */
    protected $categoryTitle = 'LC__CMDB__CATS__APPLICATION';
    ...
    {
        $objId = ($p_row['isys_cats_application_list__isys_obj__id'] ?: ($p_row['isys_obj__id'] ?: null));
    ...
    public function create(
        ...
        $l_strSql = "INSERT IGNORE INTO isys_cats_application_list
			SET isys_cats_application_list__description = " . $this->convert_sql_text($description) . ",
			isys_cats_application_list__specification  = " . $this->convert_sql_text($specification) . ",
			isys_cats_application_list__release  = " . $this->convert_sql_text($release) . ",
			isys_cats_application_list__isys_application_manufacturer__id  = " . $this->convert_sql_id($manufacturerID) . ",
			isys_cats_application_list__isys_obj__id  = " . $this->convert_sql_id($objID) . ",
			isys_cats_application_list__isys_installation_type__id = " . $this->convert_sql_id($installation_type) . ",
			isys_cats_application_list__registration_key = " . $this->convert_sql_text($registration_key) . ",
			isys_cats_application_list__install_path = " . $this->convert_sql_text($install_path) . ",
			isys_cats_application_list__status = " . $this->convert_sql_id($newRecStatus) . ";";
    ...
    {
        return [
            '_installation_count' => new DynamicProperty(
                'LC__CMDB__CATS__APPLICATION_INSTALLATION_COUNT',
