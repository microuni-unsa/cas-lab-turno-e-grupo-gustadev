...
class isys_cmdb_dao_category_s_ws_net_type extends isys_cmdb_dao_category_specific
{
    ...
    {
        $l_strSql = "INSERT IGNORE INTO isys_cats_ws_net_type_list SET
            isys_cats_ws_net_type_list__description = " . $this->convert_sql_text($p_description) . ",
            isys_cats_ws_net_type_list__isys_net_type_title__id  = " . $this->convert_sql_id($p_titleID) . ",
            isys_cats_ws_net_type_list__status = " . C__RECORD_STATUS__NORMAL . ",
            isys_cats_ws_net_type_list__isys_obj__id = " . $this->convert_sql_id($p_objID) . ";";
