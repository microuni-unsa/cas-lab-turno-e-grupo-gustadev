 ...
 */
class isys_cmdb_dao_category_s_person_group_contact_assign extends isys_cmdb_dao_category_specific implements ObjectBrowserAssignedEntries
{
    /**
     ...
     * @var string
     */
    protected $categoryTitle = 'LC__CMDB__CONTACT_ASSIGNMENT__PERSON_GROUP';
        ...
        return [
            ...
            'description' => array_replace_recursive(isys_cmdb_dao_category_pattern::commentary(), [
                ...
                C__PROPERTY__DATA     => [
                    ...
                    C__PROPERTY__DATA__SELECT => \idoit\Module\Report\SqlQuery\Structure\SelectSubSelect::factory(
                        'SELECT isys_catg_contact_list__description
                            FROM isys_catg_contact_list
                            INNER JOIN isys_connection ON isys_connection__id = isys_catg_contact_list__isys_connection__id',
                        'isys_connection',
                        'isys_connection__id',
    ...
    public function save($p_catlevel, $p_status, $p_connection, $p_role, $p_objID, $p_description)
    {
        $l_sql = "UPDATE isys_catg_contact_list SET
            isys_catg_contact_list__status = " . $this->convert_sql_id($p_status ?: C__RECORD_STATUS__NORMAL) . ",
