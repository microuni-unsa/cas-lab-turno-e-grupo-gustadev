...
class isys_cmdb_dao_list_catg_manual extends isys_component_dao_category_table_list
{
    ...
    public function modify_row(&$p_row)
    {
        ...
        if ($p_row["isys_file_version__isys_file_physical__id"] !== null) {
            ...
            $p_row["download"] = '<a target="_blank" href="' . $downloadUrl . '"><img src="' . $g_dirs["images"] . '/axialis/basic/symbol-download.svg" class="vam" />&nbsp;' .
    ...
    public function get_fields()
    {
        return [
            ...
            'isys_catg_manual_list__description' => 'LC__CMDB__CAT__COMMENTARY',
        ];
    }
}
