...
{
    private int $virtualMachineTagCounter = 0;
    ...
    public function get_result($p_table = null, $p_object_id = null, $p_cRecStatus = null)
    {
        ...
        return $l_dao->get_data(
            ...
            $l_dao->convert_sql_int($l_cRecStatus),
            null,
            $l_cRecStatus
        );
    }
    ...
    public function modify_row(&$p_arrRow)
    {
        ...
        $l_params = [
            ...
            "name"              => "C__CATG__VIRTUAL_MACHINE_TAG_" . ($this->virtualMachineTagCounter++),
        ...
        $p_arrRow["connected_title"] = isys_ajax_handler_quick_info::instance()
            ->getQuickInfoReplacement($l_row["isys_obj__id"], $l_row["isys_obj__title"]);
