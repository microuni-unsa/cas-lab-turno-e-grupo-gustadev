...
class isys_cmdb_dao_list_catg_raid extends isys_component_dao_category_table_list
{
    ...
    public function modify_row(&$p_arrRow)
    {
        ...
        $l_dao_stor = isys_cmdb_dao_category_g_stor::instance($this->m_db);
        $l_dao_drive = isys_cmdb_dao_category_g_drive::instance($this->m_db);
    ...
    {
        return [
            'isys_catg_raid_list__title'       => 'LC__CATG__RAID_TITLE',
            'isys_stor_raid_level__title'      => 'LC__CMDB__CATG__RAIDLEVEL',
            'isys_raid_type__title'            => 'LC__CMDB__RAID_TYPE',
            'isys_capacity'                    => 'LC__CATG__STORAGE_CAPACITY',
            'isys_catg_raid_list__description' => 'LC__CMDB__CAT__COMMENTARY',
        ];
    }
}
