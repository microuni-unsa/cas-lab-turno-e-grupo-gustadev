...
class isys_cmdb_dao_list_catg_network_interface extends isys_component_dao_category_table_list
{
    ...
    public function modify_row(&$p_arrRow)
    {
        ...
        $p_arrRow["showports"] = '<a href="' . $l_link . '" class="btn btn-small" title="' . $language->get('LC__CMDB__CATG__NETWORK__ASSO_PORTS__TOOLTIP') . '">' .
            '<img src="' . $g_dirs["images"] . 'axialis/hardware-network/power-plug.svg" alt="" />' .
            '<span>' . $language->get('LC__CMDB__CATG__NETWORK__ASSO_PORTS') . '</span></a>';
    }
    ...
    public function get_fields()
    {
        return [
            ...
            'isys_catg_netp_list__firmware'   => 'LC__CATG__INTERFACE_P_FIRMWARE',
            'showports'                       => 'LC__CMDB__CATG__NETWORK__ASSO_PORTS',
            'isys_catg_netp_list__description' => 'LC__CMDB__CAT__COMMENTARY',
        ];
    }
}
