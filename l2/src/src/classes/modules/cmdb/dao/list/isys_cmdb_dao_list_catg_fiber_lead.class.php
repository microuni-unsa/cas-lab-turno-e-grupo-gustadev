...
class isys_cmdb_dao_list_catg_fiber_lead extends isys_component_dao_category_table_list
{
    ...
    public function get_fields()
    {
        return [
            ...
            'isys_catg_fiber_lead_list__label'   => 'LC__CATG__FIBER_LEAD__LABEL',
            'isys_fiber_category__title'         => 'LC__CATG__FIBER_LEAD__CATEGORY',
            'isys_cable_colour__title'           => 'LC__CATG__FIBER_LEAD__COLOR',
            'isys_catg_fiber_lead_list__damping' => 'LC__CATG__FIBER_LEAD__DAMPING',
            'isys_catg_fiber_lead_list__description' => 'LC__CMDB__CAT__COMMENTARY',
        ];
    }
