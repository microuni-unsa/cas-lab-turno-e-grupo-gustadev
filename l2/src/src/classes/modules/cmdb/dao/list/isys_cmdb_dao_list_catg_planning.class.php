...
class isys_cmdb_dao_list_catg_planning extends isys_component_dao_category_table_list implements isys_cmdb_dao_list_interface
{
    ...
    {
        $p_row["isys_catg_planning_list__start"] = isys_application::instance()->container->get('locales')->fmt_date($p_row["isys_catg_planning_list__start"]);
        $p_row["isys_catg_planning_list__end"] = isys_application::instance()->container->get('locales')->fmt_date($p_row["isys_catg_planning_list__end"]);
    }
     ...
     */
    public function get_result($p_str = null, $p_unused = null, $p_cRecStatus = null)
    {
    ...
    {
        $p_row["isys_cmdb_status__title"] = '<div class="cmdb-marker" style="background-color:' . isys_helper_color::unifyHexColor((string)$p_row['isys_cmdb_status__color']) . ';"></div>' .
    ...
    public function get_fields()
    {
        return [
            ...
            'isys_catg_planning_list__description' => 'LC__CMDB__CAT__COMMENTARY',
        ];
    }
}
