 ...
 */
class Time extends Formatter implements FormatterInterface
{
    /**
     * @var string
     */
    protected static $type = C__PROPERTY__INFO__TYPE__TIME;
    ...
    public static function formatCell($valueFormatter)
    {
        ...
        $plugin = new isys_smarty_plugin_f_time();
