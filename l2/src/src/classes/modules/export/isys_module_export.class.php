 ...
 */
class isys_module_export extends isys_module implements AuthableInterface
{
    ...
    public function build_tree(isys_component_tree $p_tree, $p_system_module = true, $p_parent = null)
    {
        ...
        $p_tree->add_node(
            ...
            '',
            "{$wwwPath}/images/axialis/basic/magic-wand.svg",
        ...
        $p_tree->add_node(
            ...
            '',
            "{$wwwPath}/images/axialis/documents-folders/file-copy-1.svg",
    ...
    public function start()
    {
        ...
        try {
            ...
            $l_template->activate_editmode()
                ->assign('content_title', $this->language->get('LC__CMDB__EXPORT'))
                ...
                switch ($_POST['export_save']) {
                    ...
                    case self::SAVE_AS:
                        ...
                        if ($_POST['export_save_filename']) {
                            if (isys_file_put_contents($_POST['export_save_filename'], trim($l_parser->get_export()))) {
            ...
            case self::FILTER_LOCATION:
                ...
                if ($l_posts["step"] == '3') {
                    try {
                        ...
                        isys_application::instance()->container->get('notify')->warning($e->getMessage(), ['sticky' => true]);
                    }
                }
    ...
    public function templates()
    {
        ...
        $this->m_userrequest->get_navbar()
            ->set_active(isys_auth_export::instance()->is_allowed_to(isys_auth::DELETE, 'EXPORT/' . defined_or_default('C__MODULE__EXPORT') . '2'), C__NAVBAR_BUTTON__DELETE)
        ...
        if ($_GET["id"]) {
            ...
            if (count($l_exports)) {
                ...
                $l_data = $l_exports->get_row();
                $l_params = Unserialize::toArray($l_data["isys_export__params"]);
    ...
    {
        $l_params = Unserialize::toArray($p_row["isys_export__params"]);
    ...
    public function show_cmdb_view()
    {
        ...
        if ($l_objType != null) {
            ...
            if ($l_objID != null) {
                        ...
                        while ($l_row = $l_cat_res->get_row()) {
                            switch ($l_category_type_id) {
                                ...
                                case C__CMDB__CATEGORY__TYPE_CUSTOM:
                                    $l_categories[$l_category_type_id][] = $l_row['isysgui_catg_custom__id'];
                                    break;
                            }
                        }
                    }
                ...
                if (isys_file_put_contents($g_absdir . '/temp/trans.xsl', $l_xsl)) {
                    $isOverview = $l_cat == defined_or_default('C__CATG__OVERVIEW');
                    $l_parser = $l_export->export($l_objects, $l_categories, C__RECORD_STATUS__NORMAL, false, false, $isOverview)
                ...
                foreach ($l_category_types as $l_category_type_id => $l_category_type_const) {
                    if ($l_category_type_id === C__CMDB__CATEGORY__TYPE_CUSTOM && !isys_application::isPro()) {
                        continue;
                    }
                ...
                isys_file_put_contents($g_absdir . '/temp/trans.xsl', $l_xsl);
