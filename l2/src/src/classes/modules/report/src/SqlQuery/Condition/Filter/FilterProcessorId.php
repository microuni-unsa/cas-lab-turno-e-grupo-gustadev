...
class FilterProcessorId extends AbstractFilterProcessor implements FilterProcessorInterface
{
    public function process()
    {
        ...
        $result = $dao->get_data($this->getId(), null, '', null, C__RECORD_STATUS__NORMAL);
        $return = [];
