...
/**
 * Lower than current DateTime Placeholder, may be extended by user defined minutes
 *
 ...
 * @since       1.11
 */
class LowerThanCurrentDateTime implements Placeholder
{
    /**
    ...
    {
        return 'lower-than-current-date-time';
    }
    ...
    {
        if (!empty($userInput)) {
            return 'BETWEEN DATE_SUB(NOW(), INTERVAL ' . ((int)$userInput) . ' MINUTE) AND NOW()';
        }
