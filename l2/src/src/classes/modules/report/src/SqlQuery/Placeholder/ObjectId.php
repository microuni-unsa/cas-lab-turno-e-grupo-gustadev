 ...
 * @since       1.11
 */
class ObjectId implements Placeholder
{
    /**
    ...
    {
        return '=' . (!empty($userInput) ? ((int)$userInput) : ((int)$_GET[C__CMDB__GET__OBJECT]));
    }
    ...
    public function getFieldsForUserInput()
    {
        ...
        return [
            'firstLevel' => $field->navigation_edit(isys_application::instance()->container->get('template'), [
                ...
                'p_bInfoIconSpacer' => 0,
                'p_strPlaceholder'  => 'LC__REPORT__PLACEHOLDER__PLACEHOLDER__OBJECT'
            ]),
