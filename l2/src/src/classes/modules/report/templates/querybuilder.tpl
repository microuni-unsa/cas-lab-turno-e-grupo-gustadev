<style>
    [{include file="`$report_assets_dir`/css/querybuilder.css"}]
</style>
...
<div class="bg-white report-query-builder">
    ...
    <fieldset class="overview">
        <legend class="border-top-none"><span>[{isys type="lang" ident="LC__REPORT__INFO__NAME_AND_DESCRIPTION"}]</span></legend>
        ...
        <div class="p10">
            <table class="contentTable">
                ...
                <tr>
                    <td class="key">[{isys type="f_label" name="title" ident="LC__REPORT__FORM__REPORT_TYPE"}]</td>
                    <td class="value">
                        [{isys type="f_dialog" name="category_report" p_bEditMode=1 p_bDisabled=1}]
                        <input type="hidden" name="category_report" value="[{if $isCategoryReport}]on[{else}]0[{/if}]"/>
                    </td>
                </tr>
                <!-- @see ID-8402 Add a proper indicator -->
                <tr>
                    <td class="key"></td>
                    <td class="value pl20">
                        <div class="display-flex align-items-center">
                            <img src="[{$dir_images}]axialis/basic/button-info.svg" class="mr5" alt="" />
                            <span>[{isys type="lang" ident="LC__REPORT__FORM__REPORT_TYPE_DESCRIPTION"}]</span>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td class="key vat">[{isys type="f_label" name="description" ident="LC__REPORT__FORM__DESCRIPTION"}]</td>
    ...
    <fieldset class="overview p0 mt20 mb5">
        <legend style="height:55px; position:absolute;">
        ...
        <div class="p10 pt5 pb5" style="margin-top:55px;">
            <div class="hide" id="report_advanced_options">
                ...
                <table class="mt10 mb5">
                    ...
                    <tr>
                        <td><label for="keep_description_format">[{isys type="lang" ident="LC__REPORT__FORM__KEEP_DESCRIPTION_FORMAT"}]</label></td>
                        <td>[{isys type="f_dialog" p_bDbFieldNN=1 p_arData=$yes_or_no p_strSelectedID=$keep_description_format p_bSort=false name="keep_description_format" p_strClass="input-mini" p_bEditMode=1}]</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="key">[{isys type="f_label" name="assignedObjectStatusFilter" ident="LC__REPORT__INFO__STATUS_FILTER_ASSIGNED_OBJECTS_CATEGORIES"}]</td>
                        <td class="value">[{isys type="f_dialog" name="assignedObjectStatusFilter" p_bDbFieldNN='1' p_arData=$statusFilter p_strSelectedID=$assignedObjectStatusFilterValue p_bEditMode=1 p_strClass="input-mini" disableInputGroup=true}]</td>
                    </tr>
                </table>
            </div>
        </div>
    ...
    <fieldset class="overview p0 mt5 mb20">
        <legend style="height:55px;position:absolute;"><span>[{isys type="lang" ident="LC__REPORT__FORM__OUTPUT"}]<button type="button" class="ml10 vam btn btn-small checkup">[{isys type="lang" ident="LC__REPORT__FORM__CHECK"}]</button></span></legend>

        <div class="p10" style="margin-top:55px;">
    ...
    <fieldset class="overview p0 mt5">
        <legend style="height:55px;position:absolute;"><span>[{isys type="lang" ident="LC__REPORT__FORM__CONDITIONS"}]<button type="button" class="ml10 vam btn btn-small checkup">[{isys type="lang" ident="LC__REPORT__FORM__CHECK"}]</button></span></legend>
        ...
        <div id="condition_overlay" style="position:absolute; display:[{if $report_id == '' || $querybuilder_conditions == ''}]none[{/if}]; top:0; left:0; height:100%; width: 100%;">
            ...
            <div class="mt10" style="position:absolute; left:50%; margin-left: -108px; text-align: center; z-index: 1100;">
                <span class="vam"><b>[{isys type="lang" ident="LC__REPORT__FORM__LOADING_CONDITIONS"}] </b><img src="[{$dir_images}]axialis/user-interface/loading.svg" class="animation-rotate vam"/></span>
            </div>
        </div>

        <div id="ReportCondtionBlockTemplate" class="constraintDiv p10" style="display: none">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span id="ReportConditionTemplateValue">
                            <select id="querycondition_#{queryConditionBlock}_#{queryConditionLvl}_comparison" name="querycondition[#{queryConditionBlock}][#{queryConditionLvl}][comparison]" class="input reportDialog2 conditionComparison fl" style="width:120px;">
                                <option value="=">=</option>
                                <option value="&lt;">&lt;</option>
                                <option value="&gt;">&gt;</option>
                                <option value="!=">!=</option>
                            ...
                            <input id="querycondition_#{queryConditionBlock}_#{queryConditionLvl}_value" name="querycondition[#{queryConditionBlock}][#{queryConditionLvl}][value]" class="input reportInput conditionValue fl" style="width:200px;">
                            <select id="querycondition_#{queryConditionBlock}_#{queryConditionLvl}_unit" name="querycondition[#{queryConditionBlock}][#{queryConditionLvl}][unit]" class="input reportDialog2 conditionUnit fl" style="width:80px;display:none;" disabled></select>
                            <select id="ReportConditionTemplateOperator" name="querycondition[#{queryConditionBlock}][#{queryConditionLvl}][operator]" class="input reportDialog2 conditionOperator ml20" style="width:80px;display:none;">
                                <option value="AND">[{isys type="lang" ident="LC__UNIVERSAL__AND" toUpper=true}]</option>
                                <option value="OR">[{isys type="lang" ident="LC_UNIVERSAL__OR" toUpper=true}]</option>
                            </select>
                        </span>
                    </td>
                </tr>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        ...
                                        <span id="ReportConditionSubTemplateValue">
                                            ...
                                            <input id="querycondition_#{queryConditionBlock}_#{queryConditionLvl}_#{queryConditionSubLvl}_#{queryConditionSubLvlProp}_value" name="querycondition[#{queryConditionBlock}][#{queryConditionLvl}][subcnd][#{queryConditionSubLvlProp}][#{queryConditionSubLvl}][value]" class="input reportInput conditionSubValue fl" style="width:200px;">
                                            <select id="querycondition_#{queryConditionBlock}_#{queryConditionLvl}_#{queryConditionSubLvl}_#{queryConditionSubLvlProp}_unit" name="querycondition[#{queryConditionBlock}][#{queryConditionLvl}][subcnd][#{queryConditionSubLvlProp}][#{queryConditionSubLvl}][unit]" class="input reportDialog2 conditionSubUnit fl" style="width:80px;display:none;" disabled></select>
                                            <select id="ReportConditionSubTemplateOperator" name="querycondition[#{queryConditionBlock}][#{queryConditionLvl}][subcnd][#{queryConditionSubLvlProp}][#{queryConditionSubLvl}][operator]" class="input reportDialog2 conditionSubOperator ml20" style="width:80px;display:none;">
                                                <option value="AND">[{isys type="lang" ident="LC__UNIVERSAL__AND" toUpper=true}]</option>
                                                <option value="OR">[{isys type="lang" ident="LC_UNIVERSAL__OR" toUpper=true}]</option>
                                            </select>
                                        </span>
        ...
        <div class="p10" style="margin-top:55px;">
            ...
            <div id="dyn" style="min-height:50px">
                <div id="dvsn-remover" class="constraintDiv p10">[{isys type="lang" ident="LC__REPORT__FORM__NO_CONSTRAINTS_ADDED"}]</div>
            </div>

            <button type="button" class="btn">
                <img src="[{$dir_images}]axialis/basic/symbol-add.svg" /><span>[{isys type="lang" ident="LC__REPORT__FORM__BUTTON__ADD_CONDITION_BLOCK"}]</span>
            </button>
...
idoit.Translate.set('LC__REPORT__PLACEHOLDER__PLACEHOLDER__DATETIME', '[{isys type="lang" ident="LC__REPORT__PLACEHOLDER__PLACEHOLDER__DATETIME"}]');
idoit.Translate.set('LC__REPORT__PLACEHOLDER__PLACEHOLDER__OBJECT', '[{isys type="lang" ident="LC__REPORT__PLACEHOLDER__PLACEHOLDER__OBJECT"}]');
idoit.Translate.set('LC__REPORT__PLACEHOLDER__PLACEHOLDER__REGEX', '[{isys type="lang" ident="LC__REPORT__PLACEHOLDER__PLACEHOLDER__REGEX"}]');
...
idoit.Translate.set('LC__REPORT__PLACEHOLDER__CURRENT_USER', '[{isys type="lang" ident="LC__REPORT__PLACEHOLDER__CURRENT_USER"}]');
...
idoit.Translate.set('LC__REPORT__PLACEHOLDER__OLDER_THEN_DATETIME', '[{isys type="lang" ident="LC__REPORT__PLACEHOLDER__OLDER_THEN_DATETIME"}]');
idoit.Translate.set('LC__REPORT__PLACEHOLDER__YOUNGER_THEN_DATETIME', '[{isys type="lang" ident="LC__REPORT__PLACEHOLDER__YOUNGER_THEN_DATETIME"}]');
...
[{include file="`$report_assets_dir`js/report_condition.js"}]
...
$$('.checkup').invoke('on', 'click', function(e){
    ...
    // @see ID-11133 Pass optional parameters to the preview.
    get_popup('report', '', 800, 508, {
        report__HIDDEN_IDS: $F('report__HIDDEN_IDS'),
        lvls: JSON.stringify(lvls_content),
        func:'report_preview',
        display_relations: $F('display_relations'),
        empty_values: $F('empty_values'),
        sorting_direction: $F('sorting_direction'),
        statusFilter: $F('statusFilter'),
        assignedObjectStatusFilter: $F('assignedObjectStatusFilter'),
    });
});
