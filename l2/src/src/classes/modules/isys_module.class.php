 ...
 */
abstract class isys_module implements isys_module_interface
{
     ...
     */
    private static bool $m_licenced = false;
    ...
    /**
     * Is this module licensed, or not?
     *
     * @return  boolean
     */
    final public static function is_licenced()
    {
        return static::$m_licenced ?? true;
    }
    ...
    {
        return __DIR__ . '/' . str_replace('isys_module_', '', static::class) . '/';
    }
    ...
    {
        return isys_application::instance()->www_path . 'src/classes/modules/' . str_replace('isys_module_', '', static::class) . '/';
    }
     ...
     * @param int|string|null     $parentNode
     */
    public function build_tree(isys_component_tree $tree, bool $isSystemModule = true, int|string|null $parentNode = null)
    {
     ...
     * @return $this
     */
    public function set_data(array $p_data): self
    {
        $this->m_data = $p_data;
     ...
     * @param null  $p_data       (optional) Data. Defaults to null.
     * @param null  $p_result     (optional) Validation result. Defaults to null.
     * @return array
     * @throws Exception
     */
    public function prepare_user_data_assignment($p_properties, $p_data = null, $p_result = null)
    {
        $l_content = [];
        ...
        foreach ($p_properties as $l_property_id => $l_property_info) {
            ...
            switch ($l_property_info[C__PROPERTY__UI][C__PROPERTY__UI__TYPE]) {
                ...
                case C__PROPERTY__UI__TYPE__TIME:
    ...
    /**
     * returns purified get parameters
     *
     * @return array
     * @deprecated Will be removed in i-doit 40!
     */
    ...
    {
        return Purify::purifyParams($_GET);
    }

    /**
     * returns purified get parameter
     *
     * @param $key
     * @return mixed
     * @deprecated Will be removed in i-doit 40!
    ...
    {
        return Purify::purifyParameter($key, $_GET);
    }

    /**
     * returns purified post parameters
     *
     * @return array
     * @deprecated Will be removed in i-doit 40!
     */
    ...
    {
        return Purify::purifyParams($_POST);
    }

    /**
     * returns purified post parameter
     *
     * @param $key
     * @return mixed
     * @deprecated Will be removed in i-doit 40!
    ...
    {
        return Purify::purifyParameter($key, $_POST);
    }
    ...
    {
        return Purify::purifyValue($value);
    }
    ...
    {
        return $this->m_data['isys_module__identifier'] ?? '';
    }
}
