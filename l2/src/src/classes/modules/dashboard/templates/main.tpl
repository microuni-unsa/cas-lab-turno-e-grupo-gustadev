...
<script type="text/javascript">
	...
	window.is_allowed_to_configure_dashboard = '[{intval($is_allowed_to_configure_dashboard)}]';
	window.is_allowed_to_configure_widgets = '[{intval($is_allowed_to_configure_widgets)}]';
