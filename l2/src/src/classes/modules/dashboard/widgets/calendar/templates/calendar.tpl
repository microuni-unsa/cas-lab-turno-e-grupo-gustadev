<style type="text/css">
    ...
    table.calendar tbody td.weekend {
        ...
        color: #e42d2c; /* SCSS: red */
    }

    table.calendar td.bg-neutral-200 {
        background: transparent;
        color: #c8c9c9; /* SCSS: neutral-400 */
    }

    table.calendar td.weekend.bg-neutral-200 {
        background: transparent;
        color: #f3b8b8; /* SCSS: red-light */
    }

    table.calendar td.today {
        background: #f7da8e; /* SCSS: yellow-light */
    }

	table.calendar tbody td:hover {
		border: 1px solid #c8c9c9; /* SCSS: neutral-400 */
	}


	table.calendar tbody td span.marker {
		border-width: 3px;
		padding: 1px 3px;
		margin: 0 -8px;
	}
...
<div id="[{$unique_id}]_popup" class="border blurred-shadow hide">
	<h4 class="bg-neutral-200 p5" style="border-bottom:1px solid #888;">
