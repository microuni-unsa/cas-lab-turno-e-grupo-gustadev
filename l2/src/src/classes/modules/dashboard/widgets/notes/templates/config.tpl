<table class="contentTable" id="config_[{$unique_id}]">
	...
	<tr>
		...
		<td class="value">[{isys type="f_colorpicker" name="widget-popup-config-color" p_strValue=$rules.color size="small" parent="#config_`$unique_id`"}]</td>
	</tr>
	<tr>
		<td class="key">[{isys type="f_label" name="widget-popup-config-fontcolor" ident="LC__WIDGET__NOTES__CONFIG__FONTCOLOR"}]</td>
		<td class="value">[{isys type="f_colorpicker" name="widget-popup-config-fontcolor" p_strValue=$rules.fontcolor size="small" parent="#config_`$unique_id`"}]</td>
	</tr>
	<tr>
