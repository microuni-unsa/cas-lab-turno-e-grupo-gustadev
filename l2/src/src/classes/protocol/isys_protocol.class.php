...
abstract class isys_protocol
{
    ...
    protected ?int $tlsCertificate = null;
    ...
    {
        if (is_resource($this->m_connection) || $this->m_connection instanceof CurlHandle) {
     ...
     * @return $this
     */
    public function setTlsCertificate(?int $tlsCertificate = null): self
    {
    ...
    public static function get_instance(string $host, int $port, string $protocol): static
    {
