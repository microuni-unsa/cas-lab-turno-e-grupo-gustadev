<table class="contentTable fl m5">
	...
	<tr>
		...
		<td class="value border-top">[{$stats.free.horizontal.front}]</td>
		<td class="value border-top">[{$stats.free.horizontal.back}]</td>
		<td class="value border-top">
	...
	<tr>
		...
		<td class="value border-top">[{$stats.free.vertical.front}]</td>
		<td class="value border-top">[{$stats.free.vertical.back}]</td>
		<td class="value border-top">
...
<table class="contentTable fl m5">
	...
	[{foreach $stats.connectors as $objectType => $connectors}]
		<tr>
			<td class="key"><span class="mr10">[{isys type="lang" ident=$objectType}] <span class="text-neutral-400">([{isys type="lang" ident="LC__CMDB__CATG__CONNECTOR__FRONT"}])</span></span></td>
			<td class="value border-top">[{foreach $connectors.in as $type => $connector}][{$type}]<br />[{/foreach}]</td>
			<td class="value border-top">[{foreach $connectors.in as $type => $connector}][{$connector.free}]<br />[{/foreach}]</td>
			<td class="value border-top">[{foreach $connectors.in as $type => $connector}][{$connector.used}]<br />[{/foreach}]</td>
		</tr>
		<tr>
			<td class="key"><span class="mr10">[{isys type="lang" ident=$objectType}] <span class="text-neutral-400">([{isys type="lang" ident="LC__CMDB__CATG__CONNECTOR__BACK"}])</span></span></td>
			<td class="value border-top">[{foreach $connectors.out as $type => $connector}][{$type}]<br />[{/foreach}]</td>
			<td class="value border-top">[{foreach $connectors.out as $type => $connector}][{$connector.free}]<br />[{/foreach}]</td>
			<td class="value border-top">[{foreach $connectors.out as $type => $connector}][{$connector.used}]<br />[{/foreach}]</td>
		</tr>
	[{/foreach}]
	[{foreach $stats.ports as $objectType => $ports}]
		<tr>
			<td class="key"><span class="mr10">[{isys type="lang" ident=$objectType}]</span></td>
			<td class="value border-top">[{foreach $ports as $type => $port}][{$type}]<br />[{/foreach}]</td>
			<td class="value border-top">[{foreach $ports as $type => $port}][{$port.free}]<br />[{/foreach}]</td>
			<td class="value border-top">[{foreach $ports as $type => $port}][{$port.used}]<br />[{/foreach}]</td>
		</tr>
	[{/foreach}]
</table>
