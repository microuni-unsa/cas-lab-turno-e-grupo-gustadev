[{if $active}]
    ...
    <table class="contentTable">
        <tr id="catg_livestatus_host_state">
            <td class="key">[{isys type="lang" ident="LC__CATG__LIVESTATUS__CURRENT_STATE"}]</td>
            <td class="value">
    ...
    <script type="text/javascript">
        (function () {
            ...
            const $tableRow = $('catg_livestatus_host_state');
                    ...
                    onSuccess:  function (transport) {
                        ...
                        if (json.success) {
                            ...
                            if (json.data.hasOwnProperty('host_state')) {
                                ...
                                $tableRow
                                    .down('td.value')
                                    .addClassName(json.data.state.color)
                            ...
                            $tableRow
                                .down('td.value')
                                .update(new Element('div', {className:'m5 p5 box-red'}).update(json.message));
                        }
                    }
                });
            }
