		...
		<td class="value pl20">
			[{if isys_glob_is_edit_mode()}]
				<label>
					...
					[{isys type="lang" ident="LC__UNIVERSAL__OBJECT_TITLE"}] ("<span class="text-neutral-400">[{$hostname_obj_title}]</span>")
				</label>
				<br />
				<label>
					...
					[{isys type="lang" ident="LC__CATP__IP__HOSTNAME_FQDN"}] ("<span class="text-neutral-400">[{$hostname_hostname_fqdn}]</span>")
				</label>
				<br />
				<label>
					...
					[{isys type="lang" ident="LC__CATP__IP__HOSTNAME"}] ("<span class="text-neutral-400">[{$hostname_hostname}]</span>")
				</label>
				<br />
