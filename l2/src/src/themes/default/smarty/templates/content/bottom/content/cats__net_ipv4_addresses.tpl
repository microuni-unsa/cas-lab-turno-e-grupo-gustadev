<div class="p10" style="min-height: 400px">
    [{if $has_execute_right && $featureAvailable}]
    <div class="mb10">
        <button id="ping-all" type="button" class="btn mr5" title="[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__PING_USES_`$ping_method`"}]">
            <img src="[{$dir_images}]axialis/hardware-network/computer-network.svg" alt=""><span>[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__PING"}]</span>
        </button>
        <button id="nslookup-all" type="button" class="btn mr5">
            <img src="[{$dir_images}]axialis/basic/zoom.svg" alt=""><span>[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__NSLOOKUP"}]</span>
        </button>
        <button id="r-nslookup-all" type="button" class="btn">
            <img src="[{$dir_images}]axialis/basic/zoom.svg" alt=""><span>[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__REVERSE_NSLOOKUP"}]</span>
        </button>
    </div>
    [{/if}]
            ...
            <tr id="ip-table-obj-adder">
                ...
                <td>
                    <button id="C__CATS__IP_ADDRESSES__GLOBAL_BUTTON" type="button" class="btn" title="[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__CONNECT"}]">
                        <img src="[{$dir_images}]axialis/basic/link.svg" />
                    </button>
                </td>
            </tr>
        </tbody>
    ...
    <div id="box-scroller" class="mr20">
        <div class="border" id="statistic-box">
            <h3 class="mouse-pointer" onclick="this.next('ul').toggleClassName('hide');">
                <img src="[{$dir_images}]axialis/spreadsheet/chart-line-2d-dots.svg" alt="" class="ml10 mr10" />
            ...
            <ul class="m0 list-style-none border-top">
                ...
                <li>
                    ...
                    <span id="statistic-net-address" class="ml5 text-neutral-400">[{$net_address}]</span>
                </li>
                <li>
                    [{isys type="lang" ident="LC__CATP__IP__SUBNETMASK"}]
                    <span id="statistic-net-subnetmask" class="ml5 text-neutral-400">[{$net_subnet_mask}] (/[{$net_cidr_suffix}])</span>
                </li>
                <li>
                    [{isys type="lang" ident="LC__CATP__IP__DEFAULTGATEWAY"}]
                    <span id="statistic-net-default_gateway" class="ml5 text-neutral-400">[{$address_default_gateway}]</span>
                </li>
                <li>
                    [{isys type="lang" ident="LC__CMDB__CATS__NET__ADDRESS_RANGE"}]
                    <span id="statistic-net-ip_range" class="ml5 text-neutral-400">[{$address_range_from}] - [{$address_range_to}]</span>
                </li>
                <li>
                ...
                <li>
                    ...
                    <span class="ml5">[{if $layer2_net}][{$layer2_net}][{else}]-[{/if}]</span>
                </li>
            </ul>
        </div>
        ...
        <div class="border" id="legend-box">
            <h3 class="mouse-pointer" onclick="this.next('ul').toggleClassName('hide');" title="[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__LEGEND"}]">
                <img src="[{$dir_images}]axialis/spreadsheet/charts-doughnut-color-filled.svg" alt="" class="ml10 mr10" />
                <span>[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__LEGEND"}]</span>
                <button id="hide-show-unused" class="btn btn-small ml-auto" type="button">
                    <img src="[{$dir_images}]axialis/basic/eye.svg" /><span>[{isys type='lang' ident='LC__CMDB__CATS__NET_IP_ADDRESSES__TOGGLE_VIEW'}]</span>
                </button>
            </h3>
            <ul class="m0 list-style-none border-top">
                ...
                <li class="static-address">
                    <div class="display-flex align-items-center">
                        <span>[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__STATIC"}]</span>
                        [{if $has_edit_right}]
                        <button id="new-static-area" class="btn btn-small ml-auto" type="button">
                            <img src="[{$dir_images}]axialis/basic/symbol-add.svg" /><span>[{isys type='lang' ident='LC__CMDB__CATS__NET_IP_ADDRESSES__NEW_AREA'}]</span>
                        </button>
                        [{/if}]
                    </div>
                </li>
                <li class="dhcp-reserved-address">
                    <div class="display-flex align-items-center">
                        <span>[{isys type="lang" ident="LC__CATP__IP__ASSIGN__DHCP_RESERVED"}]</span>
                        [{if $has_edit_right}]
                        <button id="new-reserved-dhcp-area" class="btn btn-small ml-auto" type="button">
                            <img src="[{$dir_images}]axialis/basic/symbol-add.svg" /><span>[{isys type='lang' ident='LC__CMDB__CATS__NET_IP_ADDRESSES__NEW_AREA'}]</span>
                        </button>
                        [{/if}]
                    </div>
                ...
                <li class="dhcp-address">
                    <div class="display-flex align-items-center">
                        <span>DHCP</span>
                        [{if $has_edit_right}]
                        <button id="new-dhcp-area" class="btn btn-small ml-auto" type="button">
                            <img src="[{$dir_images}]axialis/basic/symbol-add.svg" /><span>[{isys type='lang' ident='LC__CMDB__CATS__NET_IP_ADDRESSES__NEW_AREA'}]</span>
                        </button>
                        [{/if}]
                    </div>
        ...
        <div class="border" id="zone-box">
            <h3 class="mouse-pointer" onclick="this.next('ul').toggleClassName('hide');">
                <img src="[{$dir_images}]axialis/spreadsheet/charts-doughnut-color-filled.svg" alt="" class="ml10 mr10" />
                <span>[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__ZONES"}]</span>
            </h3>
            ...
            [{foreach $zones as $zone}]
                <li style="background-color: [{$zone.color}]">
                    <div class="display-flex align-items-center">
                        ...
                        [{if $has_edit_right}]
                        <button class="btn btn-small ml-auto" style="flex-shrink: 0" type="button" data-zone-id="[{$zone.id}]">
                            <img src="[{$dir_images}]axialis/basic/symbol-add.svg" /><span>[{isys type='lang' ident='LC__CMDB__CATS__NET_IP_ADDRESSES__NEW_AREA'}]</span>
                        </button>
                        [{/if}]
                    </div>
        ...
        <div class="box-red p10">
            ...
            [{isys type="lang" ident="LC__REPORT__VIEW__LAYER3_NETS__IP_ADDRESSES"}]: [{$address_conflict_ips}]
        </div>
...
(function () {
    ...
    var hosts = $H(JSON.parse('[{$hosts|json_encode|escape:"javascript"}]')),
        non_addressed_hosts = JSON.parse('[{$non_addressed_hosts|json_encode|escape:"javascript"}]'),
    ...
    var render_nslookup = function (ip_address, hostname, domains) {
        ...
        if (hostname && cache_data.hasOwnProperty('nslookup_ips') && cache_data.nslookup_ips.hasOwnProperty(ip_address)) {
            if (cache_data.nslookup_ips[ip_address] === false) {
                $ip = new Element('img', {src:'[{$dir_images}]axialis/basic/button-help.svg', className:'mr5 vam mouse-help', title: '[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__NSLOOKUP_NO_HOST_FOUND"}]'});
            } else {
        ...
        if (cache_data.hasOwnProperty('nslookup_hostnames') && cache_data.nslookup_hostnames.hasOwnProperty(ip_address)) {
            if (cache_data.nslookup_hostnames[ip_address] === false) {
                $hostname = new Element('img', {src:'[{$dir_images}]axialis/basic/button-help.svg', className:'mr5 vam mouse-help', title: '[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__REVERSE_NSLOOKUP_NO_HOST_FOUND"}]'});
            } else {
                match = false;
    ...
    var render_list = function() {
        ...
        if (display_unused) {
            ...
            for (i = 0; i <= diff; i ++) {
                ...
                if (typeof hosts.get(IPv4.long2ip(act_ip)) != 'undefined') {
                    ...
                    for (cnt in host) {
                        ...
                        $action = new Element('button', {type: 'button', className:'btn btn-mini object-btn', onClick: 'idoit.callbackManager.triggerCallback(\'iplist_disconnect\', ' + host[cnt].list_id + ')', title:'[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__DISCONNECT" p_bHtmlEncode=false}]', 'data-tooltip': 1})
                            .update(new Element('img', {src:'[{$dir_images}]axialis/basic/link-broken.svg'}));

                        /* [{if $has_execute_right && $featureAvailable}] */
                        $ping = new Element('button', {type: 'button', className:'btn btn-mini ping-btn ml5', onClick: 'idoit.callbackManager.triggerCallback(\'iplist_ping\', \'' + IPv4.long2ip(act_ip) + '\', this);', title:'[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__PING"}]', 'data-tooltip': 1})
                            .update(new Element('img', {src:'[{$dir_images}]axialis/hardware-network/computer-network.svg'}));

                        /* [{if !$nslookup_available}] */
                        $nslookup = new Element('button', {type: 'button', className:'btn btn-mini nslookup-btn ml5', title:'[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__NOTIFY__NSLOOKUP_NOT_FOUND" p_bHtmlEncode=false}]', disabled:true, 'data-tooltip': 1})
                            .update(new Element('img', {src:'[{$dir_images}]axialis/basic/zoom.svg'}))
                            .disable();

                        $r_nslookup = new Element('button', {type: 'button', className:'btn btn-mini r_nslookup-btn ml5', title:'[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__NOTIFY__NSLOOKUP_NOT_FOUND" p_bHtmlEncode=false}]', disabled:true, 'data-tooltip': 1})
                            .update(new Element('img', {src:'[{$dir_images}]axialis/basic/zoom.svg'}));
                        /* [{else}] */
                        $nslookup = new Element('button', {type: 'button', className:'btn btn-mini nslookup-btn ml5', onClick: 'idoit.callbackManager.triggerCallback(\'iplist_nslookup\', ' + parseInt(host[cnt].catg_ip_id) + ', this);', title:'[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__NSLOOKUP" p_bHtmlEncode=false}]', 'data-tooltip': 1})
                            .update(new Element('img', {src:'[{$dir_images}]axialis/basic/zoom.svg'}))
                            .disable();

                        $r_nslookup = new Element('button', {type: 'button', className:'btn btn-mini r_nslookup-btn ml5', onClick: 'idoit.callbackManager.triggerCallback(\'iplist_r_nslookup\', ' + parseInt(host[cnt].catg_ip_id) + ', this);', title:'[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__REVERSE_NSLOOKUP" p_bHtmlEncode=false}]', 'data-tooltip': 1})
                            .update(new Element('img', {src:'[{$dir_images}]axialis/basic/zoom.svg'}));
                    ...
                    if (class_name != 'used default-gateway' && class_name != 'used reserved') {
                        /*[{if $has_edit_right}]*/
                        $action = new Element('button', {type: 'button', className:'btn btn-mini object-btn', onClick: 'idoit.callbackManager.triggerCallback(\'iplist_connect\', \'' + IPv4.long2ip(act_ip) + '\')', title:'[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__CONNECT"}]', 'data-tooltip': 1})
                            .update(new Element('img', {src:'[{$dir_images}]axialis/basic/link.svg'}));
                        /*[{/if}]*/
                        ...
                        $r_nslookup = new Element('button', {type: 'button', className:'btn btn-mini r_nslookup-btn ml5', title:'[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__NOTIFY__NSLOOKUP_NOT_FOUND" p_bHtmlEncode=false}]', disabled:true, 'data-tooltip': 1})
                            .update(new Element('img', {src:'[{$dir_images}]axialis/basic/zoom.svg'}));
                        /* [{else}] */
                        $nslookup = new Element('button', {type: 'button', className:'btn btn-mini nslookup-btn ml5', title:'[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__NSLOOKUP"}]', 'data-tooltip': 1})
                            .update(new Element('img', {src:'[{$dir_images}]axialis/basic/zoom.svg'}))
                            .disable();

                        $r_nslookup = new Element('button', {type: 'button', className:'btn btn-mini r_nslookup-btn ml5', onClick: 'idoit.callbackManager.triggerCallback(\'iplist_r_nslookup\', \'' + IPv4.long2ip(act_ip) + '\', this);', title:'[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__REVERSE_NSLOOKUP"}]', 'data-tooltip': 1})
                            .update(new Element('img', {src:'[{$dir_images}]axialis/basic/zoom.svg'}));
                        /* [{/if}] */
                        /* [{/if}] */
                    }
            ...
            hosts.each(function(e) {
                ...
                for(i in e.value) {
                    ...
                    $action = new Element('button', {type: 'button', className:'btn btn-mini object-btn', onClick: 'idoit.callbackManager.triggerCallback(\'iplist_disconnect\', ' + host.list_id + ')', title:'[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__DISCONNECT" p_bHtmlEncode=false}]', 'data-tooltip': 1})
                        .update(new Element('img', {src:'[{$dir_images}]axialis/basic/link-broken.svg'}));

                    /* [{if $has_execute_right && $featureAvailable}] */
                    $ping = new Element('button', {type: 'button', className:'btn btn-mini ping-btn ml5', onClick: 'idoit.callbackManager.triggerCallback(\'iplist_ping\', \'' + e[0] + '\', this);', title:'[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__PING"}]', 'data-tooltip': 1})
                        .update(new Element('img', {src:'[{$dir_images}]axialis/hardware-network/computer-network.svg'}));
                    ...
                    $r_nslookup = new Element('button', {type: 'button', className:'btn btn-mini r_nslookup-btn ml5', title:'[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__NOTIFY__NSLOOKUP_NOT_FOUND" p_bHtmlEncode=false}]', disabled:true, 'data-tooltip': 1})
                        .update(new Element('img', {src:'[{$dir_images}]axialis/basic/zoom.svg'}));
                    /* [{else}] */
                    $nslookup = new Element('button', {type: 'button', className:'btn btn-mini nslookup-btn ml5', onClick: 'idoit.callbackManager.triggerCallback(\'iplist_nslookup\', ' + parseInt(host.catg_ip_id) + ', this);', title:'[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__NSLOOKUP"}]', 'data-tooltip': 1})
                        .update(new Element('img', {src:'[{$dir_images}]axialis/basic/zoom.svg'}))
                        .disable();

                    $r_nslookup = new Element('button', {type: 'button', className:'btn btn-mini r_nslookup-btn ml5', onClick: 'idoit.callbackManager.triggerCallback(\'iplist_r_nslookup\', ' + parseInt(host.catg_ip_id) + ', this);', title:'[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__REVERSE_NSLOOKUP"}]', 'data-tooltip': 1})
                        .update(new Element('img', {src:'[{$dir_images}]axialis/basic/zoom.svg'}));
        ...
        for (i in non_addressed_hosts) {
            ...
            $action = new Element('button', {type: 'button', className:'btn btn-mini object-btn', onClick: 'idoit.callbackManager.triggerCallback(\'iplist_disconnect\', ' + non_addressed_hosts[i].list_id + ')', title:'[{isys type="lang" ident="LC__CMDB__CATS__NET_IP_ADDRESSES__DISCONNECT" p_bHtmlEncode=false}]', 'data-tooltip': 1})
                    .update(new Element('img', {src:'[{$dir_images}]axialis/basic/link-broken.svg'}));
    ...
    var connect = function (ip) {
        ...
        $('object-browser').down('button.attach').click();
    ...
    var ping = function (ip, $button, callback) {
        ...
        new Ajax.Request('?call=ip_addresses&method=ping&ajax=1', {
            ...
            onComplete: function (transport) {
                if (Object.isElement($button)) {
                    $button.enable().down('img').writeAttribute('src', '[{$dir_images}]axialis/hardware-network/computer-network.svg');
                }
    ...
    var r_ns_lookup = function (catg_ip_id, $button, callback) {
        ...
        new Ajax.Request('?call=ip_addresses&method=r_nslookup&ajax=1', {
            ...
            onComplete: function (transport) {
                if (Object.isElement($button)) {
                    $button.enable().down('img').writeAttribute('src', '[{$dir_images}]axialis/basic/zoom.svg');
                }
        ...
        new Ajax.Call('?call=ip_addresses&method=c&ajax=1',
            {
                ...
                onComplete: function (xhr) {
                    ...
                    $globalAssignButton
                        .enable()
                        .down('img').writeAttribute('src', '[{$dir_images}]axialis/basic/link.svg');
    ...
    $('contentWrapper').on('scroll', function () {
        var top = this.scrollTop, scrollThreshold;

        if (legend_scroll_at != '') {
            scrollThreshold = parseInt(legend_scroll_at);
        } else {
            scrollThreshold = 125;
        }

        if (top > scrollThreshold) {
            $boxScroller.addClassName('sticky');
            $boxScroller.setStyle({ top: '165px' });
        } else {
            $boxScroller.removeClassName('sticky');
