<table class="contentTable">
	<tr>
		...
		<td class="value">[{isys type="f_text" name="C__CATS__KRYPTO_CARD__CERTIFICATE_NUMBER"}]</td>
	</tr>
	<tr>
		...
		<td class="value">[{isys type="f_text" name="C__CATS__KRYPTO_CARD__CERTGATE_CARD_NUMBER"}]</td>
	</tr>
	<tr>
		...
		<td class="value">[{isys type="f_text" name="C__CATS__KRYPTO_CARD__CERTIFICATE_TITLE"}]</td>
	</tr>
	<tr>
		...
		<td class="value">[{isys type="f_text" name="C__CATS__KRYPTO_CARD__CERTIFICATE_PASSWORD"}]</td>
	</tr>
	<tr>
		...
		<td class="value">[{isys type="f_popup" name="C__CATS__KRYPTO_CARD__CERTIFICATE_PROCEDURE" p_strPopupType="calendar"}]</td>
	</tr>
	<tr>
		...
		<td class="value">[{isys type="f_popup" name="C__CATS__KRYPTO_CARD__DATE_OF_ISSUE" p_strPopupType="calendar"}]</td>
	</tr>
	<tr>
		<td class="key">[{isys type="f_label" ident="LC__CMDB__CATS__KRYPTO_CARD__IMEI_NUMBER" name="C__CATS__KRYPTO_CARD__IMEI_NUMBER"}]</td>
		<td class="value">[{isys type="f_text"  name="C__CATS__KRYPTO_CARD__IMEI_NUMBER"}]</td>
	</tr>
