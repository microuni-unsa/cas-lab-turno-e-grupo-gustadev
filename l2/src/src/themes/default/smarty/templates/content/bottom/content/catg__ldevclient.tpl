<table class="contentTable">
    <tr>
        <td class="key">[{isys type='f_label' name='C__CATG__LDEVCLIENT_TITLE' ident="LC__CATG__STORAGE_TITLE"}]</td>
        <td class="value">[{isys type="f_text" name="C__CATG__LDEVCLIENT_TITLE"}]</td>
    </tr>
    <tr>
        <td class="key">[{isys type='f_label' name='C__CATG__LDEVCLIENT_PATHS' ident="LC__CMDB__FC_PATH"}]</td>
        <td class="value">[{isys type="f_popup" p_strPopupType="browser_fc_port" name="C__CATG__LDEVCLIENT_PATHS"}]</td>
    </tr>
    <tr>
        <td name="san" class="key">[{isys type='f_label' name='C__CATG__LDEVCLIENT_SANPOOL__VIEW' ident="LC__CMDB__CATG__LDEV_SERVER"}]</td>
        <td class="value">
            [{isys
