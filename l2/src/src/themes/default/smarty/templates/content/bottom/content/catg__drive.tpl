...
<table class="contentTable">
    ...
    <tr>
        <td class="key">[{isys type='f_label' name='C__CATG__DRIVE_FIRMWARE' ident="LC__CMDB__CATG__DRIVE__FIRMWARE"}]</td>
        <td class="value">[{isys type="f_text" name="C__CATG__DRIVE_FIRMWARE"}]</td>
    </tr>
</table>
