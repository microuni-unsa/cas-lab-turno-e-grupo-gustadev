<div id="basic_auth">
	<p class="m10">[{isys type="lang" ident="LC__AUTH_GUI__INHERITED_RIGHTS_MESSAGE" p_bHtmlEncode=false}]</p>

	<div id="path_table" class="border mt10 m10"></div>

	[{if $edit_mode}]
		<button class="btn m5 mt15" type="button" id="new_path">
			<img src="[{$dir_images}]axialis/basic/symbol-add.svg" /><span class="vam">[{isys type="lang" ident="LC__AUTH_GUI__NEW_RIGHT"}]</span>
		</button>
	[{/if}]
</div>
