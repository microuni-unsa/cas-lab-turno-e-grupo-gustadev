<table class="contentTable">
    <tr>
        ...
        <td class="value">[{isys type='f_text' name='C__CATG__MANUAL_TITLE'}]</td>
    </tr>
    <tr>
        <td class="key">[{isys type='f_label' name='C__CATG__MANUAL_OBJ_FILE__VIEW' ident='LC__CMDB__CATG__MANUAL_OBJ_FILE'}]</td>
        <td class="value">[{isys name='C__CATG__MANUAL_OBJ_FILE' type='f_popup' p_strPopupType='browser_file'}]
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="value">
	        <a class="btn ml20" href="[{$download_link}]" target="_blank">
