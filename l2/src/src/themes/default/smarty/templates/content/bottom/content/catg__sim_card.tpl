<table class="contentTable">
	...
	<tr>
		...
		<td class="value">[{isys type="f_popup" name="C__CATS__CP_CONTRACT__START_DATE" p_strPopupType="calendar"}]</td>
	</tr>
	<tr>
		<td class="key">[{isys type='f_label' name='C__CATS__CP_CONTRACT__END_DATE__VIEW' ident="LC__CMDB__CATS_CP_CONTRACT__END_DATE"}]</td>
		<td class="value">[{isys type="f_popup" name="C__CATS__CP_CONTRACT__END_DATE" p_strPopupType="calendar"}]</td>
	</tr>
	<tr>
		<td class="key">[{isys type='f_label' name='C__CATS__CP_CONTRACT__THRESHOLD__VIEW' ident="LC__CMDB__CATS_CP_CONTRACT__THRESHOLD"}]</td>
		<td class="value">[{isys type="f_popup" name="C__CATS__CP_CONTRACT__THRESHOLD" p_strPopupType="calendar"}]</td>
	</tr>
	<tr>
...
<div id="twincard" class="mt10 [{if $g_twincard == 0}]hide[{/if}]">
	<div class="px10 border-top border-bottom bg-neutral-200 display-flex align-items-center" style="height: 40px;">Twincard</div>
