...
<table class="contentTable">
	...
	<tr>
		...
		<td class="value">
            [{isys type='f_popup' name='C__CMDB__CATG__AUDIT__PERIOD_MANUFACTURER' id='C__CMDB__CATG__AUDIT__PERIOD_MANUFACTURER' p_strPopupType='calendar'}]
        </td>
	</tr>
	<tr>
		...
		<td class="value">
            [{isys type='f_popup' name='C__CMDB__CATG__AUDIT__PERIOD_OPERATOR' id='C__CMDB__CATG__AUDIT__PERIOD_OPERATOR' p_strPopupType='calendar'}]
        </td>
	</tr>
	<tr>
		<td class="key">[{isys type='f_label' name='C__CMDB__CATG__AUDIT__APPLY__VIEW' ident='LC__CMDB__CATG__AUDIT__APPLY'}]</td>
		<td class="value">
            [{isys type='f_popup' name='C__CMDB__CATG__AUDIT__APPLY' id='C__CMDB__CATG__AUDIT__APPLY' p_strPopupType='calendar'}]
        </td>
	</tr>
	<tr>
		<td class="key vat">[{isys type='f_label' name='C__CMDB__CATG__AUDIT__RESULT' ident='LC__CMDB__CATG__AUDIT__RESULT'}]</td>
		<td class="value">
            [{isys type='f_textarea' name='C__CMDB__CATG__AUDIT__RESULT' tab='9'}]
        </td>
	</tr>
	<tr>
		<td class="key vat">[{isys type='f_label' name='C__CMDB__CATG__AUDIT__FAULT' ident='LC__CMDB__CATG__AUDIT__FAULT'}]</td>
		<td class="value">
            [{isys type='f_textarea' name='C__CMDB__CATG__AUDIT__FAULT' tab='10'}]
        </td>
	</tr>
	<tr>
		<td class="key vat">[{isys type='f_label' name='C__CMDB__CATG__AUDIT__INCIDENT' ident='LC__CMDB__CATG__AUDIT__INCIDENT'}]</td>
		<td class="value">
