...
(function () {
    ...
    window.calculate_runtime = function () {
        if (!$F('C__CATS__CONTRACT__START_DATE__VIEW').blank() && !$F('C__CATS__CONTRACT__END_DATE__VIEW').blank()) {
            ...
            $('C__CATS__CONTRACT__RUNTIME_UNIT').setValue(run_time_unit);
        } else {
    ...
    window.calculate_end_date = function () {
        var runtime_unit = $F('C__CATS__CONTRACT__RUNTIME_UNIT'),
    ...
    window.date_callback_runtime = function () {
        ...
        if (!parseInt($F('C__CATS__CONTRACT__RUNTIME')) || !parseInt($F('C__CATS__CONTRACT__RUNTIME_UNIT'))) {
            $('C__CATS__CONTRACT__RUNTIME').setValue('');
...
<table class="contentTable">
	...
	<tr>
		...
		<td class="value">
            ...
            [{isys type="f_dialog" name="C__CATS__CONTRACT__RUNTIME_UNIT"}]
		</td>
	</tr>
	<tr>
		<td class="key">[{isys type="f_label" ident="LC__CATS__CONTRACT__RUNTIME_PERIOD" name="C__CATS__CONTRACT__RUNTIME_PERIOD"}]</td>
		<td class="value">
            [{isys type="f_text" name="C__CATS__CONTRACT__RUNTIME_PERIOD"}]
	...
	<tr>
        ...
        <td class="value">[{isys type="f_data" p_strValue=$maintenance_end id="C__CATS__CONTRACT__MAINTENANCE_END"}]</td>
	</tr>
</table>
