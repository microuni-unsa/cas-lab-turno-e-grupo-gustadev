<table class="contentTable" id="editview">
	<tr>
		...
		<td class="value pl20">
			[{if $editmode == 1}]
				<div id="C__CMDB__CATS__CHASSIS__VIEW_FIELD" class="input input-small fl display-flex align-items-center" style="min-height:32px; height:auto;">
					<div>[{$view_field_content}]</div>
				</div>
            ...
            [{else}]
				<div id="C__CMDB__CATS__CHASSIS__VIEW_FIELD">
					[{$view_field_content}]
				</div>
			[{/if}]
		</td>
