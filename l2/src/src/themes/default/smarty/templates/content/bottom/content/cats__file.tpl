[{if $fileExists}]
    <table class="contentTable">
        ...
        <tr>
            <td class="key">[{isys type="f_label" ident="LC__CMDB__CATS__FILE_CATEGORY" name="C__CATS__FILE_CATEGORY"}]</td>
        ...
        <tr>
            ...
            <td class="value">
                <a href="[{$downloadLink}]" target="_blank" class="btn ml20">
                    <img src="[{$dir_images}]axialis/basic/symbol-download.svg" alt="" />
                    <span>[{isys type="lang" ident="LC__CMDB__CATS__FILE_DOWNLOAD"}]</span>
                </a>
            </td>
        </tr>
    </table>
[{else}]
    <div class="m10 p10 box-blue display-flex align-items-center">
        <img src="[{$dir_images}]axialis/basic/button-info.svg" alt="" class="mr5" />
        <span>[{isys type="lang" ident="LC__CMDB__CATS__FILE__NO_VERSION"}]</span>
    </div>
[{/if}]
