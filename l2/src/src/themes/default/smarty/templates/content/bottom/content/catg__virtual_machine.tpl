...
<table style="border-top: none; display:none;" id="vm_guest" class="contentTable">
	<tr>
		<td class="key">[{isys type="lang" ident="LC__CMDB__CATG__VM__RUNNING_ON_HOST_CLUSTER"}]</td>
		<td class="value">
    ...
    <tr>
        <td class="key">[{isys type='f_label' name='C__CATG__VM__STATE' ident="LC__CATG__VM__STATE"}]</td>
        <td class="value">[{isys type="f_dialog" name="C__CATG__VM__STATE" id="C__CATG__VM__STATE"}]</td>
    </tr>
	...
	<tr>
		<td class="key vat">[{isys type='f_label' name='C__CATG__VIRTUAL_MACHINE__ADMINISTRATION_SERVICE__VIEW' ident="LC__CMDB__CATG__CLUSTER__ADMINISTRATION_SERVICE"}]</td>
		<td class="value">
		...
		if($vm_host)
		{
			$vm_host.on('vmObject:updated', function(){
				if ($('C__CATG__VM__OBJECT__HIDDEN').value > 0) {
					var $mode;
					$mode = "[{$smarty.post.navMode|strip_tags|escape}]";
