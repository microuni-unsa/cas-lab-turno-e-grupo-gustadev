...
<fieldset class="overview">
	...
	<table class="contentTable">
		<tr>
			<td class="key">[{isys type="f_label" name="C__LOGINVENTORY__OBJTYPE" ident="LC__LOGINVENTORY__DEFAULT_OBJ_TYPE"}]</td>
			<td class="value">[{isys type="f_dialog" name="C__LOGINVENTORY__OBJTYPE" p_bDbFieldNN="1"}]</td>
		</tr>
		<tr>
			<td class="key">[{isys type="f_label" name="C__LOGINVENTORY__DEFAULT_DB" ident="LC__LOGINVENTORY__DEFAULT_DEFAULT_DB"}]</td>
			<td class="value">[{isys type="f_dialog" name="C__LOGINVENTORY__DEFAULT_DB" p_bDbFieldNN="1"}]</td>
		</tr>
		<tr>
			<td class="key">[{isys type="f_label" name="C__LOGINVENTORY__APPLICATION" ident="LC__LOGINVENTORY__REGGED_APPLICATIONS"}]</td>
			<td class="value">[{isys type="f_dialog" p_bDbFieldNN="1" name="C__LOGINVENTORY__APPLICATION"}]</td>
		</tr>
		<tr>
			<td class="key">[{isys type="f_label" name="C__LOGINVENTORY__LOGBOOK" ident="LC__LOGINVENTORY__LOGBOOK_ACTIVE_IN_IMPORT"}]</td>
