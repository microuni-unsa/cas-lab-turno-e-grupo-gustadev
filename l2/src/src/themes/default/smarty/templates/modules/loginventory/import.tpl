...
<div>
	...
	<div class="p10">
		...
		<table class="contentTable">
			...
			<tr>
				<td class="key">
					[{isys type="lang" ident="LC__LOGINVENTORY__DEFAULT_OBJ_TYPE"}]:
				</td>
				<td class="value">
