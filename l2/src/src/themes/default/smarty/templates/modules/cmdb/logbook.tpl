<table class="contentTable">
	<tr>
		...
		<td class="value vat pl20">
			...
			[{if !$disabled_on}]
			<br class="cb" />
			<div class="my20 mr20 p10 box-blue display-flex align-items-center">
				<img src="[{$dir_images}]axialis/basic/button-info.svg" class="mr10"/>
                <p>[{isys type="lang" ident="LC__MODULE__CMDB__LOGBOOK_CONFIGURATION__PLACEHOLDER_INFO"}]</p>
			</div>
			[{/if}]
		</td>
    </tr>
	...
	<table class="contentTable mt10">
		<tr>
			...
			<td class="value">
				...
				<div class="m20 p10 box-blue display-flex align-items-center">
					<img src="[{$dir_images}]axialis/basic/button-info.svg" class="mr10"/>
                    <p>[{isys type="lang" ident="LC__MODULE__CMDB__LOGBOOK_CONFIGURATION__MULTIVALUE_THRESHOLD_DESCRIPTION"}]</p>
				</div>
			</td>
		</tr>
	</table>
