...
function select_template($template) {
    ...
    for (i in selection) {
        ...
        g_templates.push({
            el: new Element('li', { className: 'p5 m0 mb5 tpl_li', id: 'tpl_li_' + g_templates.length })
                    ...
                    .insert(new Element('div', { id: 'xtmp_val_' + g_templates.length })
                        .update(new Element('img', { className: 'animation-rotate mr5', src: window.dir_images + 'axialis/user-interface/loading.svg' }))
...
function select_single_template(p_template) {
    ...
    // -1 is a special value for the nothing selected
    ...
    g_templates = [{
        el: new Element('li', { className: 'p5 m0 mb5 tpl_li', id: 'tpl_li_0' })
...
function print_list(enableSorting) {
