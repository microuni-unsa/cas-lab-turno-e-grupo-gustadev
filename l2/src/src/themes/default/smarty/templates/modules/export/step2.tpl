...
<fieldset class="overview">
    ...
    <legend class="border-top-none"><span>[{isys type='lang' ident='LC__UNIVERSAL__STEP_2'}]: [{isys type='lang' ident='LC__CMDB__EXPORT__FILTER_OBJECTS'}]</span></legend>
...
<fieldset class="overview">
    ...
    <div id="categorie_list" class="pt20 p10">
        ...
        <div id="categories">
            ...
            <label class="m5 display-block">
                <input type="checkbox" checked="checked" onclick="$('custom-categories').select('input').invoke('setValue', (this.checked ? 1 : 0))" />
                [{isys type='lang' ident='LC__UNIVERSAL__SELECT_ALL_CATEGORIES'}]
            </label>

            <div id="custom-categories" style="width: 60%">
...
<div class="p10">
    ...
    <button type="submit" class="btn" onclick="$('step').value = '1';">
        <span>[{isys type='lang' ident='LC__UNIVERSAL__BACK'}]</span>
    </button>
    <button type="submit" class="btn">
        <span>[{isys type='lang' ident='LC__CMDB__EXPORT__START'}]</span>
    </button>
</div>
