...
<div id="innercontent">
	...
	<div id="add-new" class="mt10" style="display:none;">
		<form id="form" action="?req=licences&action=add" method="post" enctype="multipart/form-data">
			...
			<fieldset>
				<legend class="bold text-shadow">Add a new license</legend>

				<table class="contentTable" width="100%">
					<colgroup><col width="160" /></colgroup>
					<tr>
						<td class="bold" valign="top">License file:</td>
						<td>
						    <input type="file" name="licence_file" /><br /><br />
                            <textarea name="license_file_raw" class="input" style="margin: 0px; width: 263px; height: 133px;"></textarea>
						</td>
					</tr>
				</table>
				...
				<div>
					<button type="button" class="btn" onclick="$('add_loading').show(); $('form').submit();">
						<img src="../images/icons/silk/add.png" class="mr5" /><span>Add license</span>
					</button>
